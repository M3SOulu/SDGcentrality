...
output_directory = "." 
model_name = "blog-microservices_01acb21"
...
product = CClass(service, "product", stereotype_instances = [internal, local_logging], tagged_values = {'Endpoints': "['/product/{productId}', '/set-processing-time']", 'Port': 8080})
...
productapi = CClass(service, "productapi", stereotype_instances = [resource_server, internal, local_logging, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}']"})
