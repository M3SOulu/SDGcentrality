...
output_directory = "." 
model_name = "blog-microservices_2451df7"
...
auth_server = CClass(service, "auth-server", stereotype_instances = [resource_server, authorization_server, infrastructural], tagged_values = {'Authorization Server': 'Spring OAuth2', 'Endpoints': "['/user']"})
...
edge_server = CClass(service, "edge-server", stereotype_instances = [local_logging, infrastructural, load_balancer, resource_server, gateway], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
