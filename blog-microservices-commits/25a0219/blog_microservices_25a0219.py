...
output_directory = "." 
model_name = "blog-microservices_25a0219"
...
hystrixdashboard = CClass(service, "hystrixdashboard", stereotype_instances = [monitoring_dashboard, infrastructural, local_logging], tagged_values = {'Port': 7979, 'Endpoints': "['/']", 'Monitoring Dashboard': 'Hystrix'})
...
products = CClass(service, "products", stereotype_instances = [circuit_breaker, internal], tagged_values = {'Port': 10011, 'Endpoints': "['/products/{productId}']"})
reviews = CClass(service, "reviews", stereotype_instances = [local_logging, circuit_breaker, internal], tagged_values = {'Endpoints': "['/reviews', '/set-processing-time']"})
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, circuit_breaker, internal], tagged_values = {'Port': 10021, 'Endpoints': "['/products/{productId}', '/']", 'Circuit Breaker': 'Hystrix'})
