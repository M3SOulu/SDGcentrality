...
output_directory = "." 
model_name = "blog-microservices_2af6251"
...
zuulserver = CClass(service, "zuulserver", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Load Balancer': 'Ribbon', 'Port': 8765, 'Gateway': 'Zuul'})
