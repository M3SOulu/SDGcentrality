...
output_directory = "." 
model_name = "blog-microservices_2d2b90b"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [local_logging, resource_server, internal, circuit_breaker], tagged_values = {'Endpoints': "['/', '/{productId}']", 'Circuit Breaker': 'Hystrix'})
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, resource_server, internal, circuit_breaker], tagged_values = {'Endpoints': "['/{productId}']", 'Circuit Breaker': 'Hystrix'})
