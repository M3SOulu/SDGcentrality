...
output_directory = "." 
model_name = "blog-microservices_319107a"
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon', 'Port': 8765})
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, circuit_breaker, internal], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}']", 'Port': 8080})
