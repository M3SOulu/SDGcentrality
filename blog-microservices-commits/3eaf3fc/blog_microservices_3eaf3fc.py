...
output_directory = "." 
model_name = "blog-microservices_3eaf3fc"
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, circuit_breaker, internal], tagged_values = {'Endpoints': "['/product/{productId}', '/ping']"})
