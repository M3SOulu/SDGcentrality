...
output_directory = "." 
model_name = "blog-microservices_428743d"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [circuit_breaker, local_logging, internal], tagged_values = {'Circuit Breaker': 'Hystrix', 'Port': 8080, 'Endpoints': "['/', '/product/{productId}']"})
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, local_logging, internal], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}']"})
