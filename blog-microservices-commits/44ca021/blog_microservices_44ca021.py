...
output_directory = "." 
model_name = "blog-microservices_44ca021"
webapp = CClass(service, "webapp", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [local_logging, internal, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/', '/product/{productId}']"})
...
zuulserver = CClass(service, "zuulserver", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Port': 8765, 'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, internal, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Port': 10001, 'Endpoints': "['/ping', '/product/{productId}']"})
