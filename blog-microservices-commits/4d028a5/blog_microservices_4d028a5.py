...
output_directory = "." 
model_name = "blog-microservices_4d028a5"
...
hystrixdashboard = CClass(service, "hystrixdashboard", stereotype_instances = [local_logging, monitoring_dashboard, infrastructural], tagged_values = {'Endpoints': "['/']", 'Port': 7979, 'Monitoring Dashboard': 'Hystrix'})
...
zuulserver = CClass(service, "zuulserver", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Port': 8765, 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
...
productapi = CClass(service, "productapi", stereotype_instances = [internal, circuit_breaker, local_logging], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/products/{productId}', '/ping']", 'Port': 10021})
