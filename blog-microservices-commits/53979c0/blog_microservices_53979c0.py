...
output_directory = "." 
model_name = "blog-microservices_53979c0"
...
review_service = CClass(service, "review-service", stereotype_instances = [internal, local_logging], tagged_values = {'Port': 8080, 'Endpoints': "['/set-processing-time', '/review']"})
...
edge_server = CClass(service, "edge-server", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon', 'Port': 8765})
