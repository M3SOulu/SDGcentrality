...
output_directory = "." 
model_name = "blog-microservices_58fa3e6"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [local_logging, resource_server, internal, load_balancer, circuit_breaker], tagged_values = {'Endpoints': "['/{productId}', '/']", 'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Spring Cloud'})
...
edge_server = CClass(service, "edge-server", stereotype_instances = [local_logging, resource_server, gateway, load_balancer, infrastructural], tagged_values = {'Port': 8765, 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
