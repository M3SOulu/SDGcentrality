...
output_directory = "." 
model_name = "blog-microservices_5a4ef40"
...
productapi = CClass(service, "productapi", stereotype_instances = [internal, local_logging, circuit_breaker], tagged_values = {'Port': 10001, 'Endpoints': "['/ping', '/product/{productId}']", 'Circuit Breaker': 'Hystrix'})
