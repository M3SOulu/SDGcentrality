...
output_directory = "." 
model_name = "blog-microservices_601aa85"
...
configserver = CClass(service, "configserver", stereotype_instances = [infrastructural, local_logging, configuration_server], tagged_values = {'Port': 8888, 'Configuration Server': 'Spring Cloud Config'})
