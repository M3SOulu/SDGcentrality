...
output_directory = "." 
model_name = "blog-microservices_6960411"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [local_logging, circuit_breaker, internal], tagged_values = {'Endpoints': "['/product/{productId}', '/']", 'Circuit Breaker': 'Hystrix'})
hystrixdashboard = CClass(service, "hystrixdashboard", stereotype_instances = [local_logging, infrastructural, monitoring_dashboard], tagged_values = {'Endpoints': "['/']", 'Monitoring Dashboard': 'Hystrix', 'Port': 7979})
...
zuulserver = CClass(service, "zuulserver", stereotype_instances = [load_balancer, infrastructural, gateway], tagged_values = {'Gateway': 'Zuul', 'Port': 8765, 'Load Balancer': 'Ribbon'})
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, circuit_breaker, internal], tagged_values = {'Port': 10001, 'Endpoints': "['/product/{productId}', '/ping']", 'Circuit Breaker': 'Hystrix'})
