...
output_directory = "." 
model_name = "blog-microservices_6c8de6a"
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, local_logging, resource_server, internal], tagged_values = {'Endpoints': "['/{productId}']", 'Circuit Breaker': 'Hystrix'})
