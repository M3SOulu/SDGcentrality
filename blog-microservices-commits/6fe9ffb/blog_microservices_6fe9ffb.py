...
output_directory = "." 
model_name = "blog-microservices_6fe9ffb"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [internal, local_logging, circuit_breaker], tagged_values = {'Endpoints': "['/product/{productId}', '/']", 'Circuit Breaker': 'Hystrix', 'Port': 8080})
...
turbine = CClass(service, "turbine", stereotype_instances = [local_logging, infrastructural, monitoring_server], tagged_values = {'Monitoring Server': 'Turbine', 'Port': 8989})
edgeserver = CClass(service, "edgeserver", stereotype_instances = [load_balancer, infrastructural, gateway], tagged_values = {'Load Balancer': 'Ribbon', 'Port': 8765, 'Gateway': 'Zuul'})
...
productapi = CClass(service, "productapi", stereotype_instances = [internal, local_logging, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}']", 'Port': 8080})
