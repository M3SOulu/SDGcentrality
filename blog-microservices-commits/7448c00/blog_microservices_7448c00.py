...
output_directory = "." 
model_name = "blog-microservices_7448c00"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [internal, local_logging, circuit_breaker, resource_server, load_balancer], tagged_values = {'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}', '/']"})
