...
output_directory = "." 
model_name = "blog-microservices_796a54e"
...
hystrixdashboard = CClass(service, "hystrixdashboard", stereotype_instances = [infrastructural, monitoring_dashboard, local_logging], tagged_values = {'Endpoints': "['/']", 'Monitoring Dashboard': 'Hystrix', 'Port': 7979})
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [load_balancer, authentication_scope_all_requests, basic_authentication, gateway, local_logging, infrastructural], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul', 'Port': 8765})
