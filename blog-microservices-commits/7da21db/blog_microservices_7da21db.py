...
output_directory = "." 
model_name = "blog-microservices_7da21db"
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, internal, local_logging], tagged_values = {'Endpoints': "['/{productId}']"})
