...
output_directory = "." 
model_name = "blog-microservices_9788057"
...
product_composite = CClass(service, "product-composite", stereotype_instances = [internal, circuit_breaker, local_logging], tagged_values = {'Endpoints': "['/product/{productId}', '/']", 'Circuit Breaker': 'Hystrix', 'Port': 8080})
...
edge_server = CClass(service, "edge-server", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Load Balancer': 'Ribbon', 'Port': 8765, 'Gateway': 'Zuul'})
...
productapi = CClass(service, "productapi", stereotype_instances = [resource_server, internal, circuit_breaker, local_logging], tagged_values = {'Endpoints': "['/{productId}']", 'Circuit Breaker': 'Hystrix'})
