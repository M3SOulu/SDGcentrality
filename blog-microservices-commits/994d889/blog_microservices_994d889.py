...
output_directory = "." 
model_name = "blog-microservices_994d889"
...
add_links({composite_service: eureka}, stereotype_instances = [restful_http, load_balanced_link, circuit_breaker_link], tagged_values = {'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix'})
