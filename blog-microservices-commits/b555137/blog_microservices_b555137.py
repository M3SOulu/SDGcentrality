...
output_directory = "." 
model_name = "blog-microservices_b555137"
webapp = CClass(service, "webapp", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [circuit_breaker, internal, local_logging], tagged_values = {'Endpoints': "['/', '/product/{productId}']", 'Circuit Breaker': 'Hystrix', 'Port': 8080})
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Port': 8765, 'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, internal, local_logging], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}']"})
