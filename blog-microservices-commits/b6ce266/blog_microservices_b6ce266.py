...
output_directory = "." 
model_name = "blog-microservices_b6ce266"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [resource_server, internal, circuit_breaker, local_logging], tagged_values = {'Endpoints': "['/', '/{productId}']", 'Circuit Breaker': 'Hystrix'})
