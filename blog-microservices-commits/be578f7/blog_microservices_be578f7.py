...
output_directory = "." 
model_name = "blog-microservices_be578f7"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [resource_server, internal, local_logging, circuit_breaker], tagged_values = {'Endpoints': "['/{productId}', '/']", 'Circuit Breaker': 'Hystrix'})
...
edge_server = CClass(service, "edge-server", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Gateway': 'Zuul', 'Port': 8765, 'Load Balancer': 'Ribbon'})
