...
output_directory = "." 
model_name = "blog-microservices_bed66de"
...
hystrixdashboard = CClass(service, "hystrixdashboard", stereotype_instances = [infrastructural, local_logging, monitoring_dashboard], tagged_values = {'Port': 7979, 'Monitoring Dashboard': 'Hystrix', 'Endpoints': "['/']"})
zuulserver = CClass(service, "zuulserver", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Port': 8765, 'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, internal, local_logging], tagged_values = {'Port': 10021, 'Endpoints': "['/products/{productId}', '/']", 'Circuit Breaker': 'Hystrix'})
