...
output_directory = "." 
model_name = "blog-microservices_c247b1f"
...
hystrixdashboard = CClass(service, "hystrixdashboard", stereotype_instances = [monitoring_dashboard, infrastructural, local_logging], tagged_values = {'Monitoring Dashboard': 'Hystrix', 'Endpoints': "['/']", 'Port': 7979})
...
zuulserver = CClass(service, "zuulserver", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon', 'Port': 8765})
...
reviews = CClass(service, "reviews", stereotype_instances = [internal, circuit_breaker], tagged_values = {'Endpoints': "['/reviews']", 'Circuit Breaker': 'Hystrix', 'Port': 10002})
productapi = CClass(service, "productapi", stereotype_instances = [internal, local_logging, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/', '/products/{productId}']", 'Port': 10021})
