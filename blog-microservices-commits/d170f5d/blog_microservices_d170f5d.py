...
output_directory = "." 
model_name = "blog-microservices_d170f5d"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [load_balancer, local_logging, resource_server, internal, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/', '/{productId}']", 'Load Balancer': 'Spring Cloud'})
...
edge_server = CClass(service, "edge-server", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon', 'Port': 8765})
