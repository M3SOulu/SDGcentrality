...
output_directory = "." 
model_name = "blog-microservices_d72149a"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [load_balancer, circuit_breaker, internal, local_logging, resource_server], tagged_values = {'Endpoints': "['/{productId}', '/']", 'Load Balancer': 'Spring Cloud'})
...
edge_server = CClass(service, "edge-server", stereotype_instances = [load_balancer, gateway, infrastructural, local_logging, resource_server], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
