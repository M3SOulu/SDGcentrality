...
output_directory = "." 
model_name = "blog-microservices_dbe95ae"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [internal, local_logging, circuit_breaker, resource_server], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}', '/']"})
...
configserver = CClass(service, "configserver", stereotype_instances = [local_logging, configuration_server, infrastructural], tagged_values = {'Configuration Server': 'Spring Cloud Config', 'Port': 8888})
...
productapi = CClass(service, "productapi", stereotype_instances = [internal, local_logging, circuit_breaker, resource_server], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}']"})
