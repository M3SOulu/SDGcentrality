...
output_directory = "." 
model_name = "blog-microservices_e36b361"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [local_logging, internal, resource_server, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}', '/']"})
...
edge_server = CClass(service, "edge-server", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon', 'Port': 8765})
