...
output_directory = "." 
model_name = "blog-microservices_e6240fb"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [internal, circuit_breaker, local_logging], tagged_values = {'Endpoints': "['/', '/product/{productId}']", 'Port': 8080, 'Circuit Breaker': 'Hystrix'})
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [load_balancer, infrastructural, gateway], tagged_values = {'Port': 8765, 'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
