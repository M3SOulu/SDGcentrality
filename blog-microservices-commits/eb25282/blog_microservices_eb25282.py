...
output_directory = "." 
model_name = "blog-microservices_eb25282"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [internal, local_logging, circuit_breaker], tagged_values = {'Endpoints': "['/', '/product/{productId}']"})
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Gateway': 'Zuul', 'Port': 8765, 'Load Balancer': 'Ribbon'})
