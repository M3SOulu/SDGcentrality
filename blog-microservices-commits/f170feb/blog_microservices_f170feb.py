...
output_directory = "." 
model_name = "blog-microservices_f170feb"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [local_logging, internal, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Port': 8080, 'Endpoints': "['/', '/product/{productId}']"})
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Port': 8765, 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
