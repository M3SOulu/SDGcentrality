...
output_directory = "." 
model_name = "blog-microservices_f26e270"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [circuit_breaker, local_logging, internal], tagged_values = {'Port': 8080, 'Endpoints': "['/product/{productId}', '/']"})
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, local_logging, internal], tagged_values = {'Port': 8080, 'Endpoints': "['/{productId}']"})
