...
output_directory = "." 
model_name = "blog-microservices_fb1e380"
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [load_balancer, infrastructural, gateway], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul', 'Port': 8765})
