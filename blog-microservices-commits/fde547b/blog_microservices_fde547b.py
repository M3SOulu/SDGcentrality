...
output_directory = "." 
model_name = "blog-microservices_fde547b"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [resource_server, internal, circuit_breaker, local_logging], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}', '/']"})
...
productapi = CClass(service, "productapi", stereotype_instances = [resource_server, internal, circuit_breaker, local_logging], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}']"})
