...
output_directory = "." 
model_name = "blog-microservices_023d592"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [local_logging, internal, resource_server, load_balancer, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}', '/']", 'Load Balancer': 'Spring Cloud'})
