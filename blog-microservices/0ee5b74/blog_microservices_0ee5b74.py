...
output_directory = "." 
model_name = "blog-microservices_0ee5b74"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [circuit_breaker, local_logging, resource_server, internal], tagged_values = {'Endpoints': "['/', '/{productId}']", 'Circuit Breaker': 'Hystrix'})
