...
output_directory = "." 
model_name = "blog-microservices_4118896"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [local_logging, internal, resource_server, circuit_breaker], tagged_values = {'Endpoints': "['/', '/{productId}']", 'Circuit Breaker': 'Hystrix'})
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, internal, resource_server, circuit_breaker], tagged_values = {'Endpoints': "['/{productId}']", 'Circuit Breaker': 'Hystrix'})
