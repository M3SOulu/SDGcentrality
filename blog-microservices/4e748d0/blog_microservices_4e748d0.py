...
output_directory = "." 
model_name = "blog-microservices_4e748d0"
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, internal, circuit_breaker], tagged_values = {'Port': 8080, 'Endpoints': "['/{productId}']"})
