...
output_directory = "." 
model_name = "blog-microservices_5e76a5b"
...
productapi = CClass(service, "productapi", stereotype_instances = [internal, local_logging, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/product/{productId}', '/ping']", 'Port': 10001})
