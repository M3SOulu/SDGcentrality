...
output_directory = "." 
model_name = "blog-microservices_621d3e4"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [circuit_breaker, local_logging, internal], tagged_values = {'Endpoints': "['/product/{productId}', '/']"})
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [authentication_scope_all_requests, load_balancer, basic_authentication, infrastructural, local_logging, gateway], tagged_values = {'Port': 8765, 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, local_logging, internal], tagged_values = {'Endpoints': "['/{productId}']"})
