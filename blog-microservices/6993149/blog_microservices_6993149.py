...
output_directory = "." 
model_name = "blog-microservices_6993149"
...
hystrixdashboard = CClass(service, "hystrixdashboard", stereotype_instances = [monitoring_dashboard, infrastructural, local_logging], tagged_values = {'Endpoints': "['/']", 'Monitoring Dashboard': 'Hystrix', 'Port': 7979})
oauth2_vanilla_authserver = CClass(service, "oauth2-vanilla-authserver", stereotype_instances = [authorization_server, infrastructural, resource_server], tagged_values = {'Authorization Server': 'Spring OAuth2', 'Endpoints': "['/user']", 'Port': 9999})
...
zuulserver = CClass(service, "zuulserver", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Load Balancer': 'Ribbon', 'Port': 8765, 'Gateway': 'Zuul'})
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, internal, local_logging], tagged_values = {'Endpoints': "['/', '/products/{productId}']", 'Circuit Breaker': 'Hystrix', 'Port': 10021})
