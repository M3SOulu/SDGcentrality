...
output_directory = "." 
model_name = "blog-microservices_7006864"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [circuit_breaker, internal, local_logging], tagged_values = {'Endpoints': "['/product/{productId}', '/']", 'Circuit Breaker': 'Hystrix'})
hystrixdashboard = CClass(service, "hystrixdashboard", stereotype_instances = [infrastructural, monitoring_dashboard, local_logging], tagged_values = {'Endpoints': "['/']", 'Port': 7979, 'Monitoring Dashboard': 'Hystrix'})
...
zuulserver = CClass(service, "zuulserver", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Port': 8765, 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, internal, local_logging], tagged_values = {'Port': 10001, 'Circuit Breaker': 'Hystrix', 'Endpoints': "['/product/{productId}', '/ping']"})
