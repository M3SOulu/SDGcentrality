...
output_directory = "." 
model_name = "blog-microservices_727bde8"
webapp = CClass(service, "webapp", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [circuit_breaker, local_logging, internal], tagged_values = {'Endpoints': "['/product/{productId}', '/']", 'Port': 8080, 'Circuit Breaker': 'Hystrix'})
