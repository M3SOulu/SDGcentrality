...
output_directory = "." 
model_name = "blog-microservices_72b944e"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [resource_server, local_logging, circuit_breaker, internal], tagged_values = {'Endpoints': "['/{productId}', '/']", 'Circuit Breaker': 'Hystrix'})
