...
output_directory = "." 
model_name = "blog-microservices_74c3728"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [resource_server, circuit_breaker, load_balancer, local_logging, internal], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}', '/']", 'Load Balancer': 'Spring Cloud'})
...
edge_server = CClass(service, "edge-server", stereotype_instances = [resource_server, gateway, load_balancer, infrastructural, local_logging], tagged_values = {'Load Balancer': 'Ribbon', 'Port': 8765, 'Gateway': 'Zuul'})
