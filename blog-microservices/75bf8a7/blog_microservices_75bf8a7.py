...
output_directory = "." 
model_name = "blog-microservices_75bf8a7"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [internal, circuit_breaker, local_logging, resource_server], tagged_values = {'Endpoints': "['/{productId}', '/']", 'Circuit Breaker': 'Hystrix'})
...
productapi = CClass(service, "productapi", stereotype_instances = [internal, circuit_breaker, local_logging, resource_server], tagged_values = {'Endpoints': "['/{productId}']", 'Circuit Breaker': 'Hystrix'})
