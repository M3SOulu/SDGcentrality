...
output_directory = "." 
model_name = "blog-microservices_7b8b59d"
...
edge_server = CClass(service, "edge-server", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Port': 8765, 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
