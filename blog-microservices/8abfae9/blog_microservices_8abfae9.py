...
output_directory = "." 
model_name = "blog-microservices_8abfae9"
...
product_composite = CClass(service, "product-composite", stereotype_instances = [internal, local_logging, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/product/{productId}', '/']", 'Port': 8080})
...
configserver = CClass(service, "configserver", stereotype_instances = [local_logging, infrastructural, configuration_server], tagged_values = {'Port': 8888, 'Configuration Server': 'Spring Cloud Config'})
...
productapi = CClass(service, "productapi", stereotype_instances = [internal, local_logging, resource_server, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}']"})
