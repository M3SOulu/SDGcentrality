...
output_directory = "." 
model_name = "blog-microservices_922a810"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [local_logging, internal, load_balancer, resource_server, circuit_breaker], tagged_values = {'Load Balancer': 'Spring Cloud', 'Endpoints': "['/{productId}', '/']", 'Circuit Breaker': 'Hystrix'})
...
add_links({composite_service: eureka}, stereotype_instances = [load_balanced_link, circuit_breaker_link, restful_http], tagged_values = {'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix'})
