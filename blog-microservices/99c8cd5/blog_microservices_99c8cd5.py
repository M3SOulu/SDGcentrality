...
output_directory = "." 
model_name = "blog-microservices_99c8cd5"
...
product = CClass(service, "product", stereotype_instances = [local_logging, internal], tagged_values = {'Endpoints': "['/product/{productId}', '/set-processing-time']", 'Port': 8080})
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Port': 8765, 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, resource_server, circuit_breaker, internal], tagged_values = {'Endpoints': "['/{productId}']", 'Circuit Breaker': 'Hystrix'})
