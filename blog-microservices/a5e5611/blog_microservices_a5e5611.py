...
output_directory = "." 
model_name = "blog-microservices_a5e5611"
...
product = CClass(service, "product", stereotype_instances = [internal], tagged_values = {'Endpoints': "['/product/{productId}']", 'Port': 8080})
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [internal, circuit_breaker, local_logging], tagged_values = {'Endpoints': "['/', '/product/{productId}']", 'Port': 8080})
...
productapi = CClass(service, "productapi", stereotype_instances = [internal, circuit_breaker, local_logging], tagged_values = {'Endpoints': "['/{productId}']", 'Port': 8080})
