...
output_directory = "." 
model_name = "blog-microservices_a7f7f42"
recommendation = CClass(service, "recommendation", stereotype_instances = [local_logging, internal], tagged_values = {'Endpoints': "['/set-processing-time', '/recommendation']", 'Port': 8080})
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [local_logging, circuit_breaker, internal], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/product/{productId}', '/']", 'Port': 8080})
...
productapi = CClass(service, "productapi", stereotype_instances = [resource_server, local_logging, circuit_breaker, internal], tagged_values = {'Endpoints': "['/{productId}']", 'Circuit Breaker': 'Hystrix'})
