...
output_directory = "." 
model_name = "blog-microservices_ac92027"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [local_logging, resource_server, circuit_breaker, internal], tagged_values = {'Endpoints': "['/', '/{productId}']", 'Circuit Breaker': 'Hystrix'})
