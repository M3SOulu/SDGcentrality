...
output_directory = "." 
model_name = "blog-microservices_aec1b3a"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [local_logging, internal, circuit_breaker], tagged_values = {'Port': 8080, 'Circuit Breaker': 'Hystrix', 'Endpoints': "['/', '/product/{productId}']"})
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Port': 8765, 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
