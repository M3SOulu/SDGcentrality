...
output_directory = "." 
model_name = "blog-microservices_b055cb1"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [resource_server, local_logging, internal, circuit_breaker], tagged_values = {'Endpoints': "['/{productId}', '/']", 'Circuit Breaker': 'Hystrix'})
...
productapi = CClass(service, "productapi", stereotype_instances = [resource_server, local_logging, internal, circuit_breaker], tagged_values = {'Endpoints': "['/{productId}']", 'Circuit Breaker': 'Hystrix'})
