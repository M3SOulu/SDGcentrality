...
output_directory = "." 
model_name = "blog-microservices_b69e02e"
...
hystrixdashboard = CClass(service, "hystrixdashboard", stereotype_instances = [local_logging, monitoring_dashboard, infrastructural], tagged_values = {'Endpoints': "['/']", 'Monitoring Dashboard': 'Hystrix', 'Port': 7979})
...
product = CClass(service, "product", stereotype_instances = [internal], tagged_values = {'Port': 10011, 'Endpoints': "['/product/{productId}']"})
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, circuit_breaker, internal], tagged_values = {'Endpoints': "['/products/{productId}', '/ping']", 'Circuit Breaker': 'Hystrix', 'Port': 10021})
