...
output_directory = "." 
model_name = "blog-microservices_becebd9"
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, internal, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Port': 8080, 'Endpoints': "['/{productId}']"})
