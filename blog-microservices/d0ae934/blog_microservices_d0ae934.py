...
output_directory = "." 
model_name = "blog-microservices_d0ae934"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [circuit_breaker, local_logging, internal], tagged_values = {'Endpoints': "['/product/{productId}', '/']", 'Port': 8080})
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, local_logging, internal], tagged_values = {'Endpoints': "['/{productId}']", 'Port': 8080})
