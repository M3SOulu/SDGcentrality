...
output_directory = "." 
model_name = "blog-microservices_d613b9f"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [internal, local_logging, circuit_breaker], tagged_values = {'Port': 8080, 'Circuit Breaker': 'Hystrix', 'Endpoints': "['/', '/product/{productId}']"})
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon', 'Port': 8765})
