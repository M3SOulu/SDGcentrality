...
output_directory = "." 
model_name = "blog-microservices_e3afaf6"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [circuit_breaker, internal, local_logging], tagged_values = {'Circuit Breaker': 'Hystrix', 'Port': 8080, 'Endpoints': "['/product/{productId}', '/']"})
...
productapi = CClass(service, "productapi", stereotype_instances = [resource_server, circuit_breaker, internal, local_logging], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/{productId}']"})
...
github_repository = CClass(external_component, "github-repository", stereotype_instances = [entrypoint, github_repository], tagged_values = {'URL': '${HOME}/Desktop/config-repo\n'})
