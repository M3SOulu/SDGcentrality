...
output_directory = "." 
model_name = "blog-microservices_ea11ba5"
...
product_composite = CClass(service, "product-composite", stereotype_instances = [local_logging, circuit_breaker, internal], tagged_values = {'Port': 8080, 'Endpoints': "['/', '/product/{productId}']", 'Circuit Breaker': 'Hystrix'})
...
productapi = CClass(service, "productapi", stereotype_instances = [local_logging, circuit_breaker, internal, resource_server], tagged_values = {'Endpoints': "['/{productId}']", 'Circuit Breaker': 'Hystrix'})
