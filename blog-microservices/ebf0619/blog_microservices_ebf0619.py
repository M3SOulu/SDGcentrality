...
output_directory = "." 
model_name = "blog-microservices_ebf0619"
...
composite_service = CClass(service, "composite-service", stereotype_instances = [resource_server, local_logging, load_balancer, internal, circuit_breaker], tagged_values = {'Load Balancer': 'Spring Cloud', 'Endpoints': "['/{productId}', '/']"})
...
edge_server = CClass(service, "edge-server", stereotype_instances = [resource_server, local_logging, gateway, load_balancer, infrastructural], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul', 'Port': 8765})
