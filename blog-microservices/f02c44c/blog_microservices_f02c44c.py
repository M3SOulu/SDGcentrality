...
output_directory = "." 
model_name = "blog-microservices_f02c44c"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [circuit_breaker, local_logging, internal], tagged_values = {'Port': 8080, 'Endpoints': "['/', '/product/{productId}']", 'Circuit Breaker': 'Hystrix'})
