...
output_directory = "." 
model_name = "blog-microservices_f885b02"
...
productcomposite = CClass(service, "productcomposite", stereotype_instances = [internal, local_logging, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/product/{productId}', '/']"})
...
zuulserver = CClass(service, "zuulserver", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon', 'Port': 8765})
...
productapi = CClass(service, "productapi", stereotype_instances = [internal, local_logging, circuit_breaker], tagged_values = {'Endpoints': "['/product/{productId}', '/ping']", 'Circuit Breaker': 'Hystrix', 'Port': 10001})
