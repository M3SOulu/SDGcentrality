...
output_directory = "." 
model_name = "blog-microservices_fbf8252"
...
productapi = CClass(service, "productapi", stereotype_instances = [circuit_breaker, internal, local_logging], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/ping', '/product/{productId}']", 'Port': 10001})
