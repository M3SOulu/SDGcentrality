...
output_directory = "." 
model_name = "blog-microservices_ff0ceec"
...
review = CClass(service, "review", stereotype_instances = [local_logging, internal], tagged_values = {'Endpoints': "['/review', '/set-processing-time']", 'Port': 8080})
productcomposite = CClass(service, "productcomposite", stereotype_instances = [local_logging, internal, circuit_breaker], tagged_values = {'Endpoints': "['/product/{productId}', '/']", 'Circuit Breaker': 'Hystrix', 'Port': 8080})
...
edgeserver = CClass(service, "edgeserver", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Load Balancer': 'Ribbon', 'Port': 8765, 'Gateway': 'Zuul'})
