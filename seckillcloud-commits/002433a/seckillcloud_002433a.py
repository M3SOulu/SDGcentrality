...
output_directory = "." 
model_name = "seckillcloud_002433a"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, internal], tagged_values = {'Port': 8889, 'Logging Technology': 'Lombok'})
