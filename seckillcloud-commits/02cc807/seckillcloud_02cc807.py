...
output_directory = "." 
model_name = "seckillcloud_02cc807"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, local_logging, encryption, pre_authorized_endpoints, internal], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/deletes', '/{id}/edit', '/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
