...
output_directory = "." 
model_name = "seckillcloud_092cbca"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, local_logging, csrf_disabled, internal, pre_authorized_endpoints], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/{id}/edit', '/{id}', '/deletes', '/updateUsing/{id}']", 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Port': 5672, 'Username': 'guest'})
