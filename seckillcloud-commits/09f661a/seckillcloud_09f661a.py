...
output_directory = "." 
model_name = "seckillcloud_09f661a"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, local_logging, internal, encryption], tagged_values = {'Pre-authorized Endpoints': "['/{id}', '/updateUsing/{id}', '/deletes', '/{id}/edit']", 'Logging Technology': 'Lombok', 'Port': 8070})
