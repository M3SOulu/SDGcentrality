...
output_directory = "." 
model_name = "seckillcloud_199ad26"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, internal, pre_authorized_endpoints, csrf_disabled, encryption], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
