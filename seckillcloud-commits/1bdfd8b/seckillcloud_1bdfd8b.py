...
output_directory = "." 
model_name = "seckillcloud_1bdfd8b"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, local_logging, encryption, csrf_disabled, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}', '/deletes', '/{id}/edit']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, plaintext_credentials, infrastructural], tagged_values = {'Message Broker': 'RabbitMQ', 'Port': 5672, 'Password': 'guest', 'Username': 'guest'})
