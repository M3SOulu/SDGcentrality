...
output_directory = "." 
model_name = "seckillcloud_1bf9f51"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, local_logging, encryption, internal, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, infrastructural, message_broker], tagged_values = {'Username': 'guest', 'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Port': 5672})
