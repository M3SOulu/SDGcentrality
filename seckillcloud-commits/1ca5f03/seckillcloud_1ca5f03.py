...
output_directory = "." 
model_name = "seckillcloud_1ca5f03"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, local_logging, csrf_disabled, encryption, pre_authorized_endpoints], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070})
