...
output_directory = "." 
model_name = "seckillcloud_1eb7807"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, local_logging, csrf_disabled, encryption, internal], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/updateUsing/{id}', '/{id}/edit', '/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
