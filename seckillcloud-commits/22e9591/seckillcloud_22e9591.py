...
output_directory = "." 
model_name = "seckillcloud_22e9591"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, local_logging, encryption, internal, pre_authorized_endpoints], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/{id}', '/{id}/edit', '/deletes', '/updateUsing/{id}']"})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Username': 'guest', 'Password': 'guest', 'Message Broker': 'RabbitMQ', 'Port': 5672})
