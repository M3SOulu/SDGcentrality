...
output_directory = "." 
model_name = "seckillcloud_2599a5a"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, local_logging, pre_authorized_endpoints, internal, csrf_disabled], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/findAll']"})
