...
output_directory = "." 
model_name = "seckillcloud_270d4d9"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, internal, csrf_disabled, encryption, pre_authorized_endpoints], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/deletes', '/{id}', '/{id}/edit', '/updateUsing/{id}']", 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, infrastructural, message_broker], tagged_values = {'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Port': 5672, 'Username': 'guest'})
