...
output_directory = "." 
model_name = "seckillcloud_2a29331"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, pre_authorized_endpoints, encryption, local_logging, csrf_disabled], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/deletes', '/{id}/edit', '/{id}', '/updateUsing/{id}']", 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Port': 5672, 'Password': 'guest'})
