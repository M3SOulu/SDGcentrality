...
output_directory = "." 
model_name = "seckillcloud_2abe315"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, csrf_disabled, pre_authorized_endpoints, local_logging, encryption], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/deletes', '/{id}']", 'Logging Technology': 'Lombok'})
