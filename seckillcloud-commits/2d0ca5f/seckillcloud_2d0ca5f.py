...
output_directory = "." 
model_name = "seckillcloud_2d0ca5f"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, internal, pre_authorized_endpoints, csrf_disabled, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
