...
output_directory = "." 
model_name = "seckillcloud_2dc3f89"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, internal, local_logging, csrf_disabled, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}', '/deletes', '/{id}/edit']", 'Port': 8070, 'Logging Technology': 'Lombok'})
