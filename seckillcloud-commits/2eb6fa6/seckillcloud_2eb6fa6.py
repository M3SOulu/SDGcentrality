...
output_directory = "." 
model_name = "seckillcloud_2eb6fa6"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, encryption, local_logging, pre_authorized_endpoints, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Logging Technology': 'Lombok', 'Port': 8070})
