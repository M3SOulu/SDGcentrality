...
output_directory = "." 
model_name = "seckillcloud_2ff7490"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, local_logging, encryption, internal], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/{id}', '/updateUsing/{id}', '/deletes']", 'Port': 8070, 'Logging Technology': 'Lombok'})
