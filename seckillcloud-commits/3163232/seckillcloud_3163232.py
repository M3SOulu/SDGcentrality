...
output_directory = "." 
model_name = "seckillcloud_3163232"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, csrf_disabled, encryption, local_logging, pre_authorized_endpoints], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070})
