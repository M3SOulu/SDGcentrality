...
output_directory = "." 
model_name = "seckillcloud_355acc1"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, internal, csrf_disabled, pre_authorized_endpoints, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
