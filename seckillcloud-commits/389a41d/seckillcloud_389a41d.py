...
output_directory = "." 
model_name = "seckillcloud_389a41d"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, local_logging, internal, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/deletes', '/updateUsing/{id}', '/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, message_broker, infrastructural], tagged_values = {'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Port': 5672, 'Username': 'guest'})
