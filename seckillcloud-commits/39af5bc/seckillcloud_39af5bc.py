...
output_directory = "." 
model_name = "seckillcloud_39af5bc"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, csrf_disabled, pre_authorized_endpoints, encryption, internal], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
