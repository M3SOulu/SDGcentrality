...
output_directory = "." 
model_name = "seckillcloud_3a5aa67"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, local_logging, pre_authorized_endpoints, internal], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Username': 'guest', 'Password': 'guest', 'Port': 5672, 'Message Broker': 'RabbitMQ'})
