...
output_directory = "." 
model_name = "seckillcloud_3aee09a"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, pre_authorized_endpoints, csrf_disabled, encryption, internal], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
