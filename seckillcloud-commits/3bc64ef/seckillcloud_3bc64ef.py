...
output_directory = "." 
model_name = "seckillcloud_3bc64ef"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, csrf_disabled, pre_authorized_endpoints, encryption, internal], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Logging Technology': 'Lombok', 'Port': 8070})
