...
output_directory = "." 
model_name = "seckillcloud_3f56f93"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, local_logging, pre_authorized_endpoints, csrf_disabled, internal], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/{id}/edit', '/deletes', '/{id}', '/updateUsing/{id}']", 'Port': 8070})
