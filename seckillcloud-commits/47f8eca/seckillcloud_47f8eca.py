...
output_directory = "." 
model_name = "seckillcloud_47f8eca"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, pre_authorized_endpoints, internal, local_logging, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/deletes', '/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, infrastructural, message_broker], tagged_values = {'Password': 'guest', 'Port': 5672, 'Username': 'guest', 'Message Broker': 'RabbitMQ'})
