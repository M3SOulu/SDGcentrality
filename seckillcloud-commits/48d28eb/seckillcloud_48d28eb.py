...
output_directory = "." 
model_name = "seckillcloud_48d28eb"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, csrf_disabled, pre_authorized_endpoints, encryption, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Logging Technology': 'Lombok', 'Port': 8070})
