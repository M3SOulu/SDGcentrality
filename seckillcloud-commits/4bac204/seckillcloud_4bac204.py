...
output_directory = "." 
model_name = "seckillcloud_4bac204"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, pre_authorized_endpoints, internal, local_logging], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/deletes', '/{id}/edit', '/{id}', '/updateUsing/{id}']", 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, infrastructural, message_broker], tagged_values = {'Username': 'guest', 'Password': 'guest', 'Message Broker': 'RabbitMQ', 'Port': 5672})
