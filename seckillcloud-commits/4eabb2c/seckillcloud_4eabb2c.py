...
output_directory = "." 
model_name = "seckillcloud_4eabb2c"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, local_logging, internal, pre_authorized_endpoints], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/deletes', '/{id}']", 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Password': 'guest', 'Port': 5672})
