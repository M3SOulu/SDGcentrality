...
output_directory = "." 
model_name = "seckillcloud_506cc04"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, internal, csrf_disabled, pre_authorized_endpoints, encryption], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Logging Technology': 'Lombok', 'Port': 8070})
