...
output_directory = "." 
model_name = "seckillcloud_58d125c"
...
database_cloud_uaa = CClass(external_component, "database-cloud-uaa", stereotype_instances = [entrypoint, external_database, exitpoint], tagged_values = {'Database': 'MySQL', 'Port': 3306})
database_cloud_mission = CClass(external_component, "database-cloud-mission", stereotype_instances = [entrypoint, external_database, exitpoint], tagged_values = {'Database': 'MySQL', 'Port': 3306})
