...
output_directory = "." 
model_name = "seckillcloud_5911d37"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, local_logging, csrf_disabled, pre_authorized_endpoints, encryption], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}/edit', '/deletes', '/{id}']", 'Port': 8070})
