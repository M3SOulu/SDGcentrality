...
output_directory = "." 
model_name = "seckillcloud_5942050"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, csrf_disabled, pre_authorized_endpoints, encryption, internal], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}', '/deletes', '/{id}/edit']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, plaintext_credentials, infrastructural], tagged_values = {'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Username': 'guest', 'Port': 5672})
