...
output_directory = "." 
model_name = "seckillcloud_5c4c63f"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, internal, pre_authorized_endpoints, local_logging, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}', '/{id}/edit', '/deletes']", 'Logging Technology': 'Lombok', 'Port': 8070})
