...
output_directory = "." 
model_name = "seckillcloud_63b9301"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, csrf_disabled, encryption, pre_authorized_endpoints, internal], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}/edit', '/deletes', '/{id}', '/updateUsing/{id}']", 'Logging Technology': 'Lombok'})
