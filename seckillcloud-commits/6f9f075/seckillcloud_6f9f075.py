...
output_directory = "." 
model_name = "seckillcloud_6f9f075"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, pre_authorized_endpoints, encryption, csrf_disabled, local_logging], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}', '/updateUsing/{id}', '/{id}/edit', '/deletes']", 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, message_broker, infrastructural], tagged_values = {'Password': 'guest', 'Username': 'guest', 'Message Broker': 'RabbitMQ', 'Port': 5672})
