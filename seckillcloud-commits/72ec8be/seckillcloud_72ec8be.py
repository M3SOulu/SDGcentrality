...
output_directory = "." 
model_name = "seckillcloud_72ec8be"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, local_logging, pre_authorized_endpoints, internal], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070, 'Logging Technology': 'Lombok'})
