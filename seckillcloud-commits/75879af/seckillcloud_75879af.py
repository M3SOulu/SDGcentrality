...
output_directory = "." 
model_name = "seckillcloud_75879af"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, pre_authorized_endpoints, local_logging, csrf_disabled, internal], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/findAll']", 'Logging Technology': 'Lombok'})
