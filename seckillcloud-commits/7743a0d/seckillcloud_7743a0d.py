...
output_directory = "." 
model_name = "seckillcloud_7743a0d"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, csrf_disabled, pre_authorized_endpoints, internal, encryption], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}/edit', '/deletes', '/{id}']", 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, message_broker, plaintext_credentials], tagged_values = {'Username': 'guest', 'Password': 'guest', 'Port': 5672, 'Message Broker': 'RabbitMQ'})
