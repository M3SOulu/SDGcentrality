...
output_directory = "." 
model_name = "seckillcloud_78de5e1"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, csrf_disabled, pre_authorized_endpoints, encryption, internal], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/{id}', '/deletes']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, infrastructural, message_broker], tagged_values = {'Port': 5672, 'Password': 'guest', 'Username': 'guest', 'Message Broker': 'RabbitMQ'})
