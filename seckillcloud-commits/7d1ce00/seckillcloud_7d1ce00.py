...
output_directory = "." 
model_name = "seckillcloud_7d1ce00"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, pre_authorized_endpoints, local_logging, internal], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/{id}', '/deletes']", 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Username': 'guest', 'Port': 5672, 'Password': 'guest', 'Message Broker': 'RabbitMQ'})
