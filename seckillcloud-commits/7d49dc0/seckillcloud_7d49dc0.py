...
output_directory = "." 
model_name = "seckillcloud_7d49dc0"
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, infrastructural, message_broker], tagged_values = {'Password': 'guest', 'Message Broker': 'RabbitMQ', 'Port': 5672, 'Username': 'guest'})
