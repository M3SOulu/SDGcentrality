...
output_directory = "." 
model_name = "seckillcloud_816441f"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, pre_authorized_endpoints, internal, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/deletes', '/{id}', '/updateUsing/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
