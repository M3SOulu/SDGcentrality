...
output_directory = "." 
model_name = "seckillcloud_852e478"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, encryption, csrf_disabled, internal, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/{id}', '/updateUsing/{id}', '/deletes']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, message_broker, infrastructural], tagged_values = {'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Port': 5672, 'Password': 'guest'})
