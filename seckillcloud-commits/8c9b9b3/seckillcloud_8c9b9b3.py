...
output_directory = "." 
model_name = "seckillcloud_8c9b9b3"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, encryption, pre_authorized_endpoints, local_logging, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
model = CBundle(model_name, elements = broker.class_object.get_connected_elements())
def run():
