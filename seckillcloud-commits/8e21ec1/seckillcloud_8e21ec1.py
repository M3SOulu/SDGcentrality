...
output_directory = "." 
model_name = "seckillcloud_8e21ec1"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, internal, csrf_disabled, local_logging, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}', '/deletes', '/{id}/edit']", 'Port': 8070, 'Logging Technology': 'Lombok'})
