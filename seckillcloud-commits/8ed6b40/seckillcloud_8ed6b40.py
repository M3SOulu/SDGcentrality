...
output_directory = "." 
model_name = "seckillcloud_8ed6b40"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, local_logging, pre_authorized_endpoints, internal], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}']", 'Logging Technology': 'Lombok'})
