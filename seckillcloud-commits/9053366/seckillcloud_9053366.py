...
output_directory = "." 
model_name = "seckillcloud_9053366"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, local_logging, encryption, internal, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/{id}/edit', '/updateUsing/{id}', '/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
