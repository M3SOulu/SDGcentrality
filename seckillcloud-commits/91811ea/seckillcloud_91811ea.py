...
output_directory = "." 
model_name = "seckillcloud_91811ea"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, internal, csrf_disabled, pre_authorized_endpoints, encryption], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070})
