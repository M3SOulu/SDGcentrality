...
output_directory = "." 
model_name = "seckillcloud_94aadfa"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, local_logging, pre_authorized_endpoints, csrf_disabled, encryption], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/deletes', '/{id}/edit', '/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
