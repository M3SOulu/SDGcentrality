...
output_directory = "." 
model_name = "seckillcloud_98ae53e"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, encryption, local_logging, pre_authorized_endpoints, csrf_disabled], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}/edit', '/{id}', '/deletes', '/updateUsing/{id}']", 'Logging Technology': 'Lombok'})
