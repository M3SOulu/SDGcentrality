...
output_directory = "." 
model_name = "seckillcloud_9bc50ae"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, pre_authorized_endpoints, encryption, csrf_disabled, local_logging], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/getMenus']", 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, message_broker, infrastructural], tagged_values = {'Port': 5672, 'Username': 'guest', 'Message Broker': 'RabbitMQ', 'Password': 'guest'})
