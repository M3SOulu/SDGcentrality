...
output_directory = "." 
model_name = "seckillcloud_9d72459"
...
cloud_gateway = CClass(service, "cloud-gateway", stereotype_instances = [local_logging, gateway, infrastructural], tagged_values = {'Port': 8205, 'Gateway': 'Spring Cloud Gateway', 'Logging Technology': 'Lombok'})
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, encryption, local_logging, csrf_disabled, pre_authorized_endpoints], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/{id}']", 'Port': 8070})
