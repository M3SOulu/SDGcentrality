...
output_directory = "." 
model_name = "seckillcloud_9da03aa"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, pre_authorized_endpoints, encryption, internal, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/{id}', '/updateUsing/{id}', '/{id}/edit']", 'Port': 8070, 'Logging Technology': 'Lombok'})
