...
output_directory = "." 
model_name = "seckillcloud_a845be6"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, internal, csrf_disabled, encryption, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/{id}', '/{id}/edit', '/updateUsing/{id}', '/deletes']", 'Logging Technology': 'Lombok', 'Port': 8070})
