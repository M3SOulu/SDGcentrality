...
output_directory = "." 
model_name = "seckillcloud_a9daf69"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, encryption, internal, local_logging], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/deletes', '/{id}/edit', '/updateUsing/{id}', '/{id}']", 'Logging Technology': 'Lombok'})
...
database_cloud_uaa = CClass(external_component, "database-cloud-uaa", stereotype_instances = [exitpoint, external_database, entrypoint], tagged_values = {'Database': 'MySQL', 'Port': 3306})
database_cloud_mission = CClass(external_component, "database-cloud-mission", stereotype_instances = [exitpoint, external_database, entrypoint], tagged_values = {'Database': 'MySQL', 'Port': 3306})
