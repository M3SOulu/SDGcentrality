...
output_directory = "." 
model_name = "seckillcloud_b206483"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, pre_authorized_endpoints, internal, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, message_broker, plaintext_credentials], tagged_values = {'Password': 'guest', 'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Port': 5672})
