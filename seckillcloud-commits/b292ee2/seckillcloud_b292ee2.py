...
output_directory = "." 
model_name = "seckillcloud_b292ee2"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, csrf_disabled, pre_authorized_endpoints, encryption, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
