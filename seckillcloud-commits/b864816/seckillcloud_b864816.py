...
output_directory = "." 
model_name = "seckillcloud_b864816"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, encryption, pre_authorized_endpoints, internal, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Port': 5672, 'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Password': 'guest'})
