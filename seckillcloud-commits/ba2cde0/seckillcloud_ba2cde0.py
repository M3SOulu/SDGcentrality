...
output_directory = "." 
model_name = "seckillcloud_ba2cde0"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, pre_authorized_endpoints, local_logging, internal], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/{id}', '/updateUsing/{id}', '/{id}/edit']", 'Logging Technology': 'Lombok', 'Port': 8070})
