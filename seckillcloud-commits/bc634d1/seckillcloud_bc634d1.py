...
output_directory = "." 
model_name = "seckillcloud_bc634d1"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, pre_authorized_endpoints, csrf_disabled, encryption, internal], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}', '/deletes', '/{id}/edit']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Port': 5672, 'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Username': 'guest'})
