...
output_directory = "." 
model_name = "seckillcloud_be26a2e"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, pre_authorized_endpoints, local_logging, internal, csrf_disabled], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070})
