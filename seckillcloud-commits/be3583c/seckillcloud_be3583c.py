...
output_directory = "." 
model_name = "seckillcloud_be3583c"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, encryption, pre_authorized_endpoints, local_logging, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
