...
output_directory = "." 
model_name = "seckillcloud_bfc4106"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, local_logging, pre_authorized_endpoints, csrf_disabled, encryption], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}', '/{id}/edit', '/deletes']"})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, message_broker, infrastructural], tagged_values = {'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Password': 'guest', 'Port': 5672})
