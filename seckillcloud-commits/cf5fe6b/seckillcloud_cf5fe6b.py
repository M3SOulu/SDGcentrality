...
output_directory = "." 
model_name = "seckillcloud_cf5fe6b"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, pre_authorized_endpoints, local_logging, internal], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/deletes', '/{id}', '/updateUsing/{id}', '/{id}/edit']"})
