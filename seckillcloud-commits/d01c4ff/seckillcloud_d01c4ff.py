...
output_directory = "." 
model_name = "seckillcloud_d01c4ff"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, csrf_disabled, encryption, local_logging, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
