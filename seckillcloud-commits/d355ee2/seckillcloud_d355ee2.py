...
output_directory = "." 
model_name = "seckillcloud_d355ee2"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, pre_authorized_endpoints, internal, local_logging, encryption], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070})
...
model = CBundle(model_name, elements = namesrv.class_object.get_connected_elements())
def run():
