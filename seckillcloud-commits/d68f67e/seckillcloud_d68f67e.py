...
output_directory = "." 
model_name = "seckillcloud_d68f67e"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, internal, encryption, local_logging, csrf_disabled], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/getMenus']", 'Logging Technology': 'Lombok'})
