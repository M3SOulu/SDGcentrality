...
output_directory = "." 
model_name = "seckillcloud_d75cee8"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, pre_authorized_endpoints, csrf_disabled, internal, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/deletes', '/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Port': 5672, 'Password': 'guest'})
