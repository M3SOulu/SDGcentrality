...
output_directory = "." 
model_name = "seckillcloud_da670f5"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, pre_authorized_endpoints, encryption, csrf_disabled, internal], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/{id}', '/{id}/edit', '/updateUsing/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
