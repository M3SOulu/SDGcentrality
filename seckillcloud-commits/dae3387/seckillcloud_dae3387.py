...
output_directory = "." 
model_name = "seckillcloud_dae3387"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, pre_authorized_endpoints, internal, local_logging, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/{id}', '/{id}/edit', '/updateUsing/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
