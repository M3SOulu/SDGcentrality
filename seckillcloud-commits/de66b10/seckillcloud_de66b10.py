...
output_directory = "." 
model_name = "seckillcloud_de66b10"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, encryption, local_logging, csrf_disabled, pre_authorized_endpoints], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/findAll']", 'Logging Technology': 'Lombok'})
