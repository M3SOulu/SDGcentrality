...
output_directory = "." 
model_name = "seckillcloud_e165a85"
...
cloud_gateway = CClass(service, "cloud-gateway", stereotype_instances = [local_logging, infrastructural, gateway], tagged_values = {'Port': 8205, 'Gateway': 'Spring Cloud Gateway', 'Logging Technology': 'Lombok'})
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, local_logging, internal, encryption], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
