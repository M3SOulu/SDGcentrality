...
output_directory = "." 
model_name = "seckillcloud_e68a794"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, local_logging, internal, pre_authorized_endpoints], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/{id}', '/deletes']"})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, message_broker, plaintext_credentials], tagged_values = {'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Password': 'guest', 'Port': 5672})
