...
output_directory = "." 
model_name = "seckillcloud_eadfc5b"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, encryption, internal, csrf_disabled, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, message_broker, plaintext_credentials], tagged_values = {'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Port': 5672, 'Username': 'guest'})
