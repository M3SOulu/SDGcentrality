...
output_directory = "." 
model_name = "seckillcloud_eb8c3e1"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, local_logging, pre_authorized_endpoints, internal], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/{id}', '/updateUsing/{id}', '/{id}/edit']", 'Logging Technology': 'Lombok', 'Port': 8070})
