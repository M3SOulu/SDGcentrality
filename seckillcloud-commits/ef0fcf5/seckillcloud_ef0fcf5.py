...
output_directory = "." 
model_name = "seckillcloud_ef0fcf5"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, pre_authorized_endpoints, internal, local_logging], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/{id}', '/{id}/edit', '/updateUsing/{id}', '/deletes']"})
