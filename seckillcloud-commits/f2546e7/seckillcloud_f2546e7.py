...
output_directory = "." 
model_name = "seckillcloud_f2546e7"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, pre_authorized_endpoints, csrf_disabled, internal, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Message Broker': 'RabbitMQ', 'Port': 5672, 'Password': 'guest', 'Username': 'guest'})
