...
output_directory = "." 
model_name = "seckillcloud_f521c9c"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, csrf_disabled, pre_authorized_endpoints, encryption, local_logging], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/updateUsing/{id}', '/deletes', '/{id}', '/{id}/edit']", 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Port': 5672, 'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Username': 'guest'})
