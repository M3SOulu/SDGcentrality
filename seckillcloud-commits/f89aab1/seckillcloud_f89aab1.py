...
output_directory = "." 
model_name = "seckillcloud_f89aab1"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, local_logging, internal, encryption, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/deletes', '/{id}', '/updateUsing/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
