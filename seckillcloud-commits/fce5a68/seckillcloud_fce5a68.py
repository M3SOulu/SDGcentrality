...
output_directory = "." 
model_name = "seckillcloud_fce5a68"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, csrf_disabled, encryption, internal, pre_authorized_endpoints], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070})
