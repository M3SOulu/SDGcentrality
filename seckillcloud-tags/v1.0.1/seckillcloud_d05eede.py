...
output_directory = "." 
model_name = "seckillcloud_d05eede"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, internal, local_logging, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Port': 5672, 'Password': 'guest', 'Username': 'guest', 'Message Broker': 'RabbitMQ'})
