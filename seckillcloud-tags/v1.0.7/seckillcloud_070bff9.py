...
output_directory = "." 
model_name = "seckillcloud_070bff9"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, local_logging, internal, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/{id}/edit', '/{id}', '/updateUsing/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
