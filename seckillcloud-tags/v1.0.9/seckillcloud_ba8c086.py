...
output_directory = "." 
model_name = "seckillcloud_ba8c086"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, local_logging, internal, csrf_disabled, encryption], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/deletes', '/{id}', '/{id}/edit', '/updateUsing/{id}']", 'Logging Technology': 'Lombok'})
