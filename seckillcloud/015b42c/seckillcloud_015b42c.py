...
output_directory = "." 
model_name = "seckillcloud_015b42c"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, pre_authorized_endpoints, csrf_disabled, internal, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Port': 5672, 'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Password': 'guest'})
