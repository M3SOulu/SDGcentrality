...
output_directory = "." 
model_name = "seckillcloud_048b29c"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, encryption, pre_authorized_endpoints, csrf_disabled, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Password': 'guest', 'Port': 5672, 'Username': 'guest', 'Message Broker': 'RabbitMQ'})
