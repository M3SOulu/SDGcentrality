...
output_directory = "." 
model_name = "seckillcloud_076d697"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, local_logging, internal, pre_authorized_endpoints, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/{id}', '/deletes']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Port': 5672, 'Password': 'guest', 'Message Broker': 'RabbitMQ', 'Username': 'guest'})
