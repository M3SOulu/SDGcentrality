...
output_directory = "." 
model_name = "seckillcloud_0d26840"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, pre_authorized_endpoints, local_logging, csrf_disabled, encryption], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/deletes', '/updateUsing/{id}', '/{id}/edit', '/{id}']", 'Logging Technology': 'Lombok'})
