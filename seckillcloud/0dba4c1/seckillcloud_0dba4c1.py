...
output_directory = "." 
model_name = "seckillcloud_0dba4c1"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, local_logging, encryption, internal, csrf_disabled], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/getMenus']", 'Logging Technology': 'Lombok'})
