...
output_directory = "." 
model_name = "seckillcloud_117d743"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, encryption, pre_authorized_endpoints, internal, csrf_disabled], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, infrastructural, message_broker], tagged_values = {'Port': 5672, 'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Password': 'guest'})
