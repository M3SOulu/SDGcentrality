...
output_directory = "." 
model_name = "seckillcloud_1336af9"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, csrf_disabled, pre_authorized_endpoints, encryption, local_logging], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}']", 'Logging Technology': 'Lombok'})
