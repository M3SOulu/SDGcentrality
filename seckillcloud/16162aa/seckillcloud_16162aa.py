...
output_directory = "." 
model_name = "seckillcloud_16162aa"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, local_logging, encryption, pre_authorized_endpoints, internal], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Logging Technology': 'Lombok', 'Port': 8070})
