...
output_directory = "." 
model_name = "seckillcloud_1673e85"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, encryption, local_logging, internal], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/updateUsing/{id}', '/deletes', '/{id}/edit', '/{id}']", 'Port': 8070})
