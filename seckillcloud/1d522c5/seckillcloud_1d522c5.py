...
output_directory = "." 
model_name = "seckillcloud_1d522c5"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, pre_authorized_endpoints, csrf_disabled, encryption, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/{id}', '/deletes', '/{id}/edit', '/updateUsing/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
