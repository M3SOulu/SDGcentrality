...
output_directory = "." 
model_name = "seckillcloud_1e202e7"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, internal, pre_authorized_endpoints, local_logging], tagged_values = {'Port': 8070, 'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/findAll']"})
