...
output_directory = "." 
model_name = "seckillcloud_28520cd"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, internal, pre_authorized_endpoints, local_logging], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/{id}', '/deletes', '/updateUsing/{id}', '/{id}/edit']"})
