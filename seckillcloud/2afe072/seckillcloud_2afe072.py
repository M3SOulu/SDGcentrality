...
output_directory = "." 
model_name = "seckillcloud_2afe072"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, encryption, csrf_disabled, internal, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/{id}', '/{id}/edit', '/updateUsing/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
