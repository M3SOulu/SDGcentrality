...
output_directory = "." 
model_name = "seckillcloud_2cb9cec"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, pre_authorized_endpoints, csrf_disabled, encryption, local_logging], tagged_values = {'Port': 8070, 'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/deletes', '/{id}', '/updateUsing/{id}', '/{id}/edit']"})
