...
output_directory = "." 
model_name = "seckillcloud_333a55e"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, internal, pre_authorized_endpoints, csrf_disabled, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/{id}', '/updateUsing/{id}', '/deletes', '/{id}/edit']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, infrastructural, message_broker], tagged_values = {'Port': 5672, 'Username': 'guest', 'Password': 'guest', 'Message Broker': 'RabbitMQ'})
