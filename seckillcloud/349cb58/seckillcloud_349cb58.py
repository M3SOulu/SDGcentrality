...
output_directory = "." 
model_name = "seckillcloud_349cb58"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, encryption, pre_authorized_endpoints, csrf_disabled, internal], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, message_broker, plaintext_credentials], tagged_values = {'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Username': 'guest', 'Port': 5672})
