...
output_directory = "." 
model_name = "seckillcloud_35c922d"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, local_logging, pre_authorized_endpoints, csrf_disabled, internal], tagged_values = {'Pre-authorized Endpoints': "['/{id}', '/deletes', '/{id}/edit', '/updateUsing/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, infrastructural, message_broker], tagged_values = {'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Username': 'guest', 'Port': 5672})
