...
output_directory = "." 
model_name = "seckillcloud_4071d58"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, csrf_disabled, encryption, pre_authorized_endpoints, internal], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}', '/{id}/edit', '/deletes']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Port': 5672, 'Password': 'guest', 'Message Broker': 'RabbitMQ', 'Username': 'guest'})
