...
output_directory = "." 
model_name = "seckillcloud_42ac32b"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, pre_authorized_endpoints, csrf_disabled, local_logging, encryption], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/{id}', '/deletes']", 'Logging Technology': 'Lombok', 'Port': 8070})
