...
output_directory = "." 
model_name = "seckillcloud_4773321"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, pre_authorized_endpoints, internal, local_logging], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/findAll']"})
