...
output_directory = "." 
model_name = "seckillcloud_4860d14"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, local_logging, pre_authorized_endpoints, internal], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/deletes', '/updateUsing/{id}', '/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
