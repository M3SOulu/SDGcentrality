...
output_directory = "." 
model_name = "seckillcloud_4a8c0f0"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, encryption, csrf_disabled, internal, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, message_broker, infrastructural], tagged_values = {'Username': 'guest', 'Port': 5672, 'Message Broker': 'RabbitMQ', 'Password': 'guest'})
