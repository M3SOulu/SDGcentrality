...
output_directory = "." 
model_name = "seckillcloud_4e82929"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, pre_authorized_endpoints, local_logging, internal], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/{id}/edit', '/{id}', '/deletes', '/updateUsing/{id}']"})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, message_broker, plaintext_credentials], tagged_values = {'Username': 'guest', 'Port': 5672, 'Password': 'guest', 'Message Broker': 'RabbitMQ'})
