...
output_directory = "." 
model_name = "seckillcloud_52e7e8d"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, pre_authorized_endpoints, local_logging, internal], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/{id}/edit', '/{id}', '/deletes', '/updateUsing/{id}']", 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, message_broker, infrastructural], tagged_values = {'Password': 'guest', 'Message Broker': 'RabbitMQ', 'Port': 5672, 'Username': 'guest'})
