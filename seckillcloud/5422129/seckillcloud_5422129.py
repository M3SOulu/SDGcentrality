...
output_directory = "." 
model_name = "seckillcloud_5422129"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, local_logging, internal, encryption, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/updateUsing/{id}', '/{id}', '/{id}/edit']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, message_broker, infrastructural], tagged_values = {'Port': 5672, 'Password': 'guest', 'Username': 'guest', 'Message Broker': 'RabbitMQ'})
