...
output_directory = "." 
model_name = "seckillcloud_5a7e628"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, encryption, local_logging, internal, csrf_disabled], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/getMenus']", 'Logging Technology': 'Lombok'})
