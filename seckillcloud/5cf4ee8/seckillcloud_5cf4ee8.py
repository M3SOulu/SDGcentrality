...
output_directory = "." 
model_name = "seckillcloud_5cf4ee8"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, csrf_disabled, encryption, local_logging, pre_authorized_endpoints], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/{id}']", 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, message_broker, plaintext_credentials], tagged_values = {'Port': 5672, 'Password': 'guest', 'Username': 'guest', 'Message Broker': 'RabbitMQ'})
