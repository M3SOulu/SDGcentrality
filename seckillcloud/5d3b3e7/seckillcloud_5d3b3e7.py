...
output_directory = "." 
model_name = "seckillcloud_5d3b3e7"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, internal, csrf_disabled, local_logging, encryption], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/{id}', '/{id}/edit', '/deletes', '/updateUsing/{id}']"})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Port': 5672, 'Username': 'guest', 'Message Broker': 'RabbitMQ', 'Password': 'guest'})
