...
output_directory = "." 
model_name = "seckillcloud_5e80147"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, internal, local_logging, encryption, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/updateUsing/{id}', '/{id}', '/{id}/edit']", 'Port': 8070, 'Logging Technology': 'Lombok'})
