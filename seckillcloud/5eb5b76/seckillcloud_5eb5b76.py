...
output_directory = "." 
model_name = "seckillcloud_5eb5b76"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, local_logging, internal, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, infrastructural, plaintext_credentials], tagged_values = {'Password': 'guest', 'Port': 5672, 'Message Broker': 'RabbitMQ', 'Username': 'guest'})
