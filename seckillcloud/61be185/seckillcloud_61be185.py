...
output_directory = "." 
model_name = "seckillcloud_61be185"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, csrf_disabled, local_logging, pre_authorized_endpoints, encryption], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070, 'Logging Technology': 'Lombok'})
