...
output_directory = "." 
model_name = "seckillcloud_6484b3a"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, pre_authorized_endpoints, internal, local_logging], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}/edit', '/{id}', '/deletes']"})
