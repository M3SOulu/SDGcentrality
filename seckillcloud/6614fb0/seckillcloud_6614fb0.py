...
output_directory = "." 
model_name = "seckillcloud_6614fb0"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, encryption, pre_authorized_endpoints, local_logging, internal], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/deletes', '/{id}/edit', '/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, message_broker, plaintext_credentials], tagged_values = {'Port': 5672, 'Username': 'guest', 'Password': 'guest', 'Message Broker': 'RabbitMQ'})
