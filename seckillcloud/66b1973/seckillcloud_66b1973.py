...
output_directory = "." 
model_name = "seckillcloud_66b1973"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, local_logging, encryption, internal, pre_authorized_endpoints], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/deletes', '/updateUsing/{id}', '/{id}', '/{id}/edit']", 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Message Broker': 'RabbitMQ', 'Port': 5672, 'Username': 'guest', 'Password': 'guest'})
