...
output_directory = "." 
model_name = "seckillcloud_6a08c65"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, local_logging, encryption, internal], tagged_values = {'Port': 8070, 'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/{id}/edit', '/deletes', '/updateUsing/{id}', '/{id}']"})
