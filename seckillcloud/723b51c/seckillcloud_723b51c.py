...
output_directory = "." 
model_name = "seckillcloud_723b51c"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, local_logging, encryption, csrf_disabled, internal], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/{id}', '/{id}/edit', '/updateUsing/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
...
database_cloud_manage = CClass(external_component, "database-cloud-manage", stereotype_instances = [external_database, entrypoint, exitpoint], tagged_values = {'Database': 'MySQL', 'Port': 3306})
