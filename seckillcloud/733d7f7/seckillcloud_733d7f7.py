...
output_directory = "." 
model_name = "seckillcloud_733d7f7"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, local_logging, encryption, csrf_disabled, internal], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070})
...
database_cloud_manage = CClass(external_component, "database-cloud-manage", stereotype_instances = [entrypoint, exitpoint, external_database], tagged_values = {'Database': 'MySQL', 'Port': 3306})
