...
output_directory = "." 
model_name = "seckillcloud_787e5b8"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, encryption, local_logging, internal, csrf_disabled], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}/edit', '/deletes', '/{id}']", 'Logging Technology': 'Lombok'})
