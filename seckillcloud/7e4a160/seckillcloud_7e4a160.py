...
output_directory = "." 
model_name = "seckillcloud_7e4a160"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, local_logging, pre_authorized_endpoints, internal, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
