...
output_directory = "." 
model_name = "seckillcloud_89a60d7"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, pre_authorized_endpoints, local_logging, encryption, csrf_disabled], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/updateUsing/{id}', '/{id}/edit', '/deletes', '/{id}']", 'Logging Technology': 'Lombok'})
