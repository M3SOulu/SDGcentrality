...
output_directory = "." 
model_name = "seckillcloud_8b07351"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, encryption, internal, local_logging, csrf_disabled], tagged_values = {'Port': 8070, 'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/getMenus']"})
