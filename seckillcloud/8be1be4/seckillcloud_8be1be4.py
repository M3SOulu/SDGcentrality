...
output_directory = "." 
model_name = "seckillcloud_8be1be4"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, local_logging, encryption, internal], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/{id}', '/updateUsing/{id}', '/{id}/edit', '/deletes']", 'Port': 8070})
