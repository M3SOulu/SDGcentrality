...
output_directory = "." 
model_name = "seckillcloud_8d5c555"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, encryption, csrf_disabled, local_logging, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070, 'Logging Technology': 'Lombok'})
