...
output_directory = "." 
model_name = "seckillcloud_90ce412"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, internal, local_logging, encryption, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/updateUsing/{id}', '/deletes', '/{id}/edit', '/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, plaintext_credentials, infrastructural], tagged_values = {'Port': 5672, 'Password': 'guest', 'Username': 'guest', 'Message Broker': 'RabbitMQ'})
