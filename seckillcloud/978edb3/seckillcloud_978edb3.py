...
output_directory = "." 
model_name = "seckillcloud_978edb3"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, local_logging, pre_authorized_endpoints, internal, csrf_disabled], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/findAll']", 'Logging Technology': 'Lombok'})
