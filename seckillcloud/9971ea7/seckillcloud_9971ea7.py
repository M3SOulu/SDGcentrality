...
output_directory = "." 
model_name = "seckillcloud_9971ea7"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, pre_authorized_endpoints, internal, csrf_disabled, encryption], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/updateUsing/{id}', '/deletes', '/{id}', '/{id}/edit']", 'Logging Technology': 'Lombok'})
...
add_links({cloud_mission: rabbitmq}, stereotype_instances = [message_producer_rabbitmq, restful_http, plaintext_credentials_link], tagged_values = {'Producer Exchange': 'None', 'Routing Key': 'None'})
