...
output_directory = "." 
model_name = "seckillcloud_a2a60f8"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, local_logging, pre_authorized_endpoints, encryption, internal], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070, 'Logging Technology': 'Lombok'})
