...
output_directory = "." 
model_name = "seckillcloud_a3cbcd1"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, internal, pre_authorized_endpoints, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/deletes', '/{id}', '/updateUsing/{id}']", 'Logging Technology': 'Lombok', 'Port': 8070})
