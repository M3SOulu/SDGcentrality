...
output_directory = "." 
model_name = "seckillcloud_a86290e"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, internal, csrf_disabled, local_logging, encryption], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/deletes', '/{id}', '/updateUsing/{id}']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Message Broker': 'RabbitMQ', 'Port': 5672, 'Password': 'guest', 'Username': 'guest'})
