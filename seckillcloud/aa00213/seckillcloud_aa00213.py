...
output_directory = "." 
model_name = "seckillcloud_aa00213"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, internal, pre_authorized_endpoints, csrf_disabled, local_logging], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070})
