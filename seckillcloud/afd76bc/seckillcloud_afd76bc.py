...
output_directory = "." 
model_name = "seckillcloud_afd76bc"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, pre_authorized_endpoints, csrf_disabled, local_logging, encryption], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/{id}', '/updateUsing/{id}', '/{id}/edit']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Username': 'guest', 'Message Broker': 'RabbitMQ', 'Password': 'guest', 'Port': 5672})
