...
output_directory = "." 
model_name = "seckillcloud_b0c1aaa"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, encryption, local_logging, csrf_disabled, pre_authorized_endpoints], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}']", 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, message_broker, plaintext_credentials], tagged_values = {'Username': 'guest', 'Password': 'guest', 'Message Broker': 'RabbitMQ', 'Port': 5672})
