...
output_directory = "." 
model_name = "seckillcloud_b194a5a"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, pre_authorized_endpoints, internal, local_logging, encryption], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/findAll']", 'Logging Technology': 'Lombok'})
