...
output_directory = "." 
model_name = "seckillcloud_b7887f6"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, local_logging, internal, encryption], tagged_values = {'Pre-authorized Endpoints': "['/deletes', '/updateUsing/{id}', '/{id}', '/{id}/edit']", 'Logging Technology': 'Lombok', 'Port': 8070})
