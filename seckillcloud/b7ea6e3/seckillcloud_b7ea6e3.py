...
output_directory = "." 
model_name = "seckillcloud_b7ea6e3"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, internal, encryption, local_logging], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/{id}', '/deletes', '/{id}/edit', '/updateUsing/{id}']", 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, message_broker, plaintext_credentials], tagged_values = {'Username': 'guest', 'Port': 5672, 'Message Broker': 'RabbitMQ', 'Password': 'guest'})
