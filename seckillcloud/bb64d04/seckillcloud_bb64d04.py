...
output_directory = "." 
model_name = "seckillcloud_bb64d04"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, csrf_disabled, internal, encryption, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070, 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, message_broker, infrastructural], tagged_values = {'Message Broker': 'RabbitMQ', 'Port': 5672, 'Username': 'guest', 'Password': 'guest'})
