...
output_directory = "." 
model_name = "seckillcloud_bb7ed1e"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, local_logging, internal, encryption], tagged_values = {'Port': 8070, 'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/deletes', '/{id}/edit', '/{id}', '/updateUsing/{id}']"})
