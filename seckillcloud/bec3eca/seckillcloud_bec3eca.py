...
output_directory = "." 
model_name = "seckillcloud_bec3eca"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, internal, pre_authorized_endpoints, csrf_disabled, local_logging], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}', '/updateUsing/{id}', '/deletes', '/{id}/edit']", 'Logging Technology': 'Lombok'})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [plaintext_credentials, message_broker, infrastructural], tagged_values = {'Port': 5672, 'Message Broker': 'RabbitMQ', 'Username': 'guest', 'Password': 'guest'})
