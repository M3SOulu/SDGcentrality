...
output_directory = "." 
model_name = "seckillcloud_c59e757"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, csrf_disabled, internal, local_logging, pre_authorized_endpoints], tagged_values = {'Pre-authorized Endpoints': "['/{id}/edit', '/{id}', '/updateUsing/{id}', '/deletes']", 'Logging Technology': 'Lombok', 'Port': 8070})
