...
output_directory = "." 
model_name = "seckillcloud_c6696a6"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [csrf_disabled, local_logging, internal, pre_authorized_endpoints, encryption], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/updateUsing/{id}', '/deletes', '/{id}/edit', '/{id}']", 'Port': 8070})
