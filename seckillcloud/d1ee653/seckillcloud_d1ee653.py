...
output_directory = "." 
model_name = "seckillcloud_d1ee653"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, pre_authorized_endpoints, encryption, csrf_disabled, internal], tagged_values = {'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/findAll']", 'Port': 8070})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [infrastructural, plaintext_credentials, message_broker], tagged_values = {'Port': 5672, 'Username': 'guest', 'Message Broker': 'RabbitMQ', 'Password': 'guest'})
