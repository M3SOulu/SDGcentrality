...
output_directory = "." 
model_name = "seckillcloud_e2b991d"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, internal, encryption, local_logging], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070, 'Logging Technology': 'Lombok'})
