...
output_directory = "." 
model_name = "seckillcloud_e4df9f9"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, encryption, internal, csrf_disabled, pre_authorized_endpoints], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/deletes', '/{id}/edit', '/updateUsing/{id}', '/{id}']", 'Logging Technology': 'Lombok'})
