...
output_directory = "." 
model_name = "seckillcloud_e98bcff"
...
cloud_gateway = CClass(service, "cloud-gateway", stereotype_instances = [local_logging, infrastructural, gateway], tagged_values = {'Gateway': 'Spring Cloud Gateway', 'Port': 8205, 'Logging Technology': 'Lombok'})
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [encryption, pre_authorized_endpoints, internal, local_logging, csrf_disabled], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/{id}', '/deletes']", 'Logging Technology': 'Lombok'})
