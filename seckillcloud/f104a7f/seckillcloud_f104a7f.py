...
output_directory = "." 
model_name = "seckillcloud_f104a7f"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, encryption, csrf_disabled, pre_authorized_endpoints, internal], tagged_values = {'Port': 8070, 'Logging Technology': 'Lombok', 'Pre-authorized Endpoints': "['/{id}/edit', '/updateUsing/{id}', '/deletes', '/{id}']"})
...
rabbitmq = CClass(service, "rabbitmq", stereotype_instances = [message_broker, plaintext_credentials, infrastructural], tagged_values = {'Password': 'guest', 'Username': 'guest', 'Port': 5672, 'Message Broker': 'RabbitMQ'})
