...
output_directory = "." 
model_name = "seckillcloud_f5709aa"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, encryption, internal, pre_authorized_endpoints, csrf_disabled], tagged_values = {'Pre-authorized Endpoints': "['/getMenus']", 'Port': 8070, 'Logging Technology': 'Lombok'})
