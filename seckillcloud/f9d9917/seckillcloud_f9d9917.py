...
output_directory = "." 
model_name = "seckillcloud_f9d9917"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [internal, local_logging, pre_authorized_endpoints, encryption, csrf_disabled], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/{id}']"})
