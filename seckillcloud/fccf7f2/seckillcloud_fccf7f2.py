...
output_directory = "." 
model_name = "seckillcloud_fccf7f2"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [local_logging, encryption, internal, pre_authorized_endpoints, csrf_disabled], tagged_values = {'Port': 8070, 'Pre-authorized Endpoints': "['/{id}']", 'Logging Technology': 'Lombok'})
