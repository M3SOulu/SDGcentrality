...
output_directory = "." 
model_name = "seckillcloud_ff9290b"
...
cloud_manage = CClass(service, "cloud-manage", stereotype_instances = [pre_authorized_endpoints, csrf_disabled, local_logging, internal, encryption], tagged_values = {'Logging Technology': 'Lombok', 'Port': 8070, 'Pre-authorized Endpoints': "['/deletes', '/{id}/edit', '/updateUsing/{id}', '/{id}']"})
