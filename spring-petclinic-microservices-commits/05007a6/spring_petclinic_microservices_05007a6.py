...
output_directory = "." 
model_name = "spring-petclinic-microservices_05007a6"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud'})
