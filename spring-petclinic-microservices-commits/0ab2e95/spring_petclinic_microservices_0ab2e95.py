...
output_directory = "." 
model_name = "spring-petclinic-microservices_0ab2e95"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Load Balancer': 'Spring Cloud', 'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Gateway': 'Spring Cloud Gateway'})
