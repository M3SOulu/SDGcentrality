...
output_directory = "." 
model_name = "spring-petclinic-microservices_0b0a590"
...
github_repository = CClass(external_component, "github-repository", stereotype_instances = [entrypoint, github_repository], tagged_values = {'URL': 'https://github.com/mszarlinski/petclinic-config-repo'})
