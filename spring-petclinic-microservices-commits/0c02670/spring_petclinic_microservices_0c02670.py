...
output_directory = "." 
model_name = "spring-petclinic-microservices_0c02670"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, load_balancer, circuit_breaker, gateway], tagged_values = {'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul'})
