...
output_directory = "." 
model_name = "spring-petclinic-microservices_0cc8450"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul', 'Port': 8081})
customers_service = CClass(service, "customers-service", stereotype_instances = [internal, local_logging], tagged_values = {'Logging Technology': 'Lombok', 'Endpoints': "['/owners/{ownerId}', '/owners']", 'Port': 8081})
