...
output_directory = "." 
model_name = "spring-petclinic-microservices_0e60e92"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul', 'Port': 8081})
