...
output_directory = "." 
model_name = "spring-petclinic-microservices_0e99140"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, circuit_breaker, infrastructural], tagged_values = {'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
