...
output_directory = "." 
model_name = "spring-petclinic-microservices_1a33a8e"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul', 'Port': 8081})
customers_service = CClass(service, "customers-service", stereotype_instances = [local_logging, internal], tagged_values = {'Endpoints': "['/owners/{ownerId}', '/owners']", 'Logging Technology': 'Lombok', 'Port': 8081})
