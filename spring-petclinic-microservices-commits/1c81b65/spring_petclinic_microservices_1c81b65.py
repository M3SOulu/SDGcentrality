...
output_directory = "." 
model_name = "spring-petclinic-microservices_1c81b65"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
