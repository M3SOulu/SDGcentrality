...
output_directory = "." 
model_name = "spring-petclinic-microservices_20a1c53"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, circuit_breaker, infrastructural], tagged_values = {'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul'})
