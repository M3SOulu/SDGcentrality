...
output_directory = "." 
model_name = "spring-petclinic-microservices_2114cf7"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
