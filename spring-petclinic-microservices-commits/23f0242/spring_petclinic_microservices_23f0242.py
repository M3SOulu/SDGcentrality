...
output_directory = "." 
model_name = "spring-petclinic-microservices_23f0242"
...
customers_service = CClass(service, "customers-service", stereotype_instances = [local_logging, internal], tagged_values = {'Port': 8081, 'Endpoints': "['/owners/{ownerId}', '/owners']", 'Logging Technology': 'Lombok'})
