...
output_directory = "." 
model_name = "spring-petclinic-microservices_25c9bee"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, circuit_breaker, load_balancer], tagged_values = {'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul', 'Load Balancer': 'Spring Cloud'})
...
add_links({api_gateway: user}, stereotype_instances = [load_balanced_link, circuit_breaker_link, restful_http], tagged_values = {'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Spring Cloud'})
add_links({api_gateway: prometheus_server}, stereotype_instances = [load_balanced_link, circuit_breaker_link, restful_http], tagged_values = {'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Spring Cloud'})
