...
output_directory = "." 
model_name = "spring-petclinic-microservices_2d002fb"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, circuit_breaker, load_balancer, gateway], tagged_values = {'Load Balancer': 'Ribbon', 'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul'})
