...
output_directory = "." 
model_name = "spring-petclinic-microservices_2d63942"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [circuit_breaker, gateway, load_balancer, infrastructural], tagged_values = {'Circuit Breaker': 'Hystrix', 'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway'})
