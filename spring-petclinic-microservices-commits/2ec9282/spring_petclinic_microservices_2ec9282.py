...
output_directory = "." 
model_name = "spring-petclinic-microservices_2ec9282"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, circuit_breaker, load_balancer, infrastructural], tagged_values = {'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Spring Cloud'})
