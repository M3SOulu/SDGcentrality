...
output_directory = "." 
model_name = "spring-petclinic-microservices_40bea02"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, circuit_breaker, infrastructural], tagged_values = {'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Ribbon'})
