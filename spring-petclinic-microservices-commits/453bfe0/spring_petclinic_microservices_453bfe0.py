...
output_directory = "." 
model_name = "spring-petclinic-microservices_453bfe0"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, infrastructural, gateway], tagged_values = {'Load Balancer': 'Spring Cloud', 'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Gateway': 'Spring Cloud Gateway'})
