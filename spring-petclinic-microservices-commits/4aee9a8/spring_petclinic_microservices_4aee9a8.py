...
output_directory = "." 
model_name = "spring-petclinic-microservices_4aee9a8"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud'})
