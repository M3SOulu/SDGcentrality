...
output_directory = "." 
model_name = "spring-petclinic-microservices_50935af"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway'})
