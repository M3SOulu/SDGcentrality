...
output_directory = "." 
model_name = "spring-petclinic-microservices_5206450"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, infrastructural, gateway], tagged_values = {'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway'})
