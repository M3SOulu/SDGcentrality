...
output_directory = "." 
model_name = "spring-petclinic-microservices_54de1ae"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, circuit_breaker, infrastructural, load_balancer], tagged_values = {'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
