...
output_directory = "." 
model_name = "spring-petclinic-microservices_5786d53"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud'})
