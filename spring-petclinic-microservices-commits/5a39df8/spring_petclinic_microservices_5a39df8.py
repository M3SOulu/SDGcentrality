...
output_directory = "." 
model_name = "spring-petclinic-microservices_5a39df8"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Port': 8081, 'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
