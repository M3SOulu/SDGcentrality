...
output_directory = "." 
model_name = "spring-petclinic-microservices_5b40494"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [circuit_breaker, gateway, load_balancer, infrastructural], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix'})
