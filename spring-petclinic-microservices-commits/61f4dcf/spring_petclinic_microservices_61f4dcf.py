...
output_directory = "." 
model_name = "spring-petclinic-microservices_61f4dcf"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, infrastructural, gateway], tagged_values = {'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud', 'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']"})
