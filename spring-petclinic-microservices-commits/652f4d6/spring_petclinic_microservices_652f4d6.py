...
output_directory = "." 
model_name = "spring-petclinic-microservices_652f4d6"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Gateway': 'Spring Cloud Gateway', 'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Load Balancer': 'Spring Cloud'})
