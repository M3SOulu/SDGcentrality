...
output_directory = "." 
model_name = "spring-petclinic-microservices_65f2c97"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, load_balancer, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul', 'Load Balancer': 'Spring Cloud'})
