...
output_directory = "." 
model_name = "spring-petclinic-microservices_8a1618d"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, circuit_breaker, gateway, load_balancer], tagged_values = {'Load Balancer': 'Ribbon', 'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul'})
