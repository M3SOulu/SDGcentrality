...
output_directory = "." 
model_name = "spring-petclinic-microservices_8e446ae"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud', 'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']"})
