...
output_directory = "." 
model_name = "spring-petclinic-microservices_8fa041c"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul'})
