...
output_directory = "." 
model_name = "spring-petclinic-microservices_909e5f7"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon', 'Port': 8081})
