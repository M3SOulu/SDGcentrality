...
output_directory = "." 
model_name = "spring-petclinic-microservices_935bd51"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway'})
