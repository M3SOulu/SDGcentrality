...
output_directory = "." 
model_name = "spring-petclinic-microservices_9d3ca03"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural, circuit_breaker], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon', 'Circuit Breaker': 'Hystrix'})
