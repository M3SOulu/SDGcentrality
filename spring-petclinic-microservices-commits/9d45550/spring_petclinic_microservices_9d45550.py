...
output_directory = "." 
model_name = "spring-petclinic-microservices_9d45550"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, circuit_breaker, load_balancer], tagged_values = {'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway', 'Circuit Breaker': 'Hystrix'})
