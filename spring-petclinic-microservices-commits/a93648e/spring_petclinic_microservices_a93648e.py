...
output_directory = "." 
model_name = "spring-petclinic-microservices_a93648e"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, infrastructural, circuit_breaker, gateway], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix'})
