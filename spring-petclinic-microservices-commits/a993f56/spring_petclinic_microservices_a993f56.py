...
output_directory = "." 
model_name = "spring-petclinic-microservices_a993f56"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Load Balancer': 'Spring Cloud', 'Port': 8081, 'Gateway': 'Zuul'})
