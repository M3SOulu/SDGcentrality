...
output_directory = "." 
model_name = "spring-petclinic-microservices_acce63b"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, infrastructural, gateway], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Spring Cloud', 'Port': 8081})
