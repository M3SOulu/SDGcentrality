...
output_directory = "." 
model_name = "spring-petclinic-microservices_b5ed632"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, circuit_breaker, infrastructural, load_balancer], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway', 'Circuit Breaker': 'Hystrix', 'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']"})
