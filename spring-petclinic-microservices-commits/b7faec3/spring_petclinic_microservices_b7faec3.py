...
output_directory = "." 
model_name = "spring-petclinic-microservices_b7faec3"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud'})
