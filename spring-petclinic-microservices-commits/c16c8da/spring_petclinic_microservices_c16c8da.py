...
output_directory = "." 
model_name = "spring-petclinic-microservices_c16c8da"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Gateway': 'Spring Cloud Gateway', 'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Load Balancer': 'Spring Cloud'})
