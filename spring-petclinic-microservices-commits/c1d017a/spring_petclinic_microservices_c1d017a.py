...
output_directory = "." 
model_name = "spring-petclinic-microservices_c1d017a"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul', 'Port': 8081})
customers_service = CClass(service, "customers-service", stereotype_instances = [local_logging, internal], tagged_values = {'Logging Technology': 'Lombok', 'Endpoints': "['/owners', '/owners/{ownerId}']", 'Port': 8081})
