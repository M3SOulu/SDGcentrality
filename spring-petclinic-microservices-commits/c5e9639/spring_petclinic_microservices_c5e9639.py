...
output_directory = "." 
model_name = "spring-petclinic-microservices_c5e9639"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Spring Cloud', 'Port': 8081})
