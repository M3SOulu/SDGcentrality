...
output_directory = "." 
model_name = "spring-petclinic-microservices_c5fd90e"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, circuit_breaker, infrastructural], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix'})
