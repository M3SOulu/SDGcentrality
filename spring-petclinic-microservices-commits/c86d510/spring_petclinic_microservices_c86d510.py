...
output_directory = "." 
model_name = "spring-petclinic-microservices_c86d510"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, infrastructural, gateway, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
