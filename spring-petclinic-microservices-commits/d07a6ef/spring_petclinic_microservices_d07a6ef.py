...
output_directory = "." 
model_name = "spring-petclinic-microservices_d07a6ef"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway', 'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']"})
