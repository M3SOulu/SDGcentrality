...
output_directory = "." 
model_name = "spring-petclinic-microservices_d7805f3"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud'})
