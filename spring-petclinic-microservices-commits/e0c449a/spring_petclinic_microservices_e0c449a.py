...
output_directory = "." 
model_name = "spring-petclinic-microservices_e0c449a"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [circuit_breaker, infrastructural, load_balancer, gateway], tagged_values = {'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix', 'Gateway': 'Spring Cloud Gateway', 'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']"})
