...
output_directory = "." 
model_name = "spring-petclinic-microservices_e418af4"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
