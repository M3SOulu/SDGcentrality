...
output_directory = "." 
model_name = "spring-petclinic-microservices_ee8fc02"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway'})
