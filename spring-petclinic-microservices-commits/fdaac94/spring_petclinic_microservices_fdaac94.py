...
output_directory = "." 
model_name = "spring-petclinic-microservices_fdaac94"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Port': 8081, 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
