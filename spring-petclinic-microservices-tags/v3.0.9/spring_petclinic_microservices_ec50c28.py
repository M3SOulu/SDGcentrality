...
output_directory = "." 
model_name = "spring-petclinic-microservices_ec50c28"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud', 'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']"})
