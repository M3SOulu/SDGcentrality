...
output_directory = "." 
model_name = "spring-petclinic-microservices_161c6bb"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway', 'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']"})
