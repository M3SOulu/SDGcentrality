...
output_directory = "." 
model_name = "spring-petclinic-microservices_01641cc"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud', 'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']"})
