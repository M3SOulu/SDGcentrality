...
output_directory = "." 
model_name = "spring-petclinic-microservices_09172e9"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway'})
...
add_links({api_gateway: prometheus_server}, stereotype_instances = [restful_http, load_balanced_link], tagged_values = {'Load Balancer': 'Spring Cloud'})
