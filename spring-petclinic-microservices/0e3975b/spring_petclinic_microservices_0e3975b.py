...
output_directory = "." 
model_name = "spring-petclinic-microservices_0e3975b"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud'})
