...
output_directory = "." 
model_name = "spring-petclinic-microservices_1860fff"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, circuit_breaker, infrastructural], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix'})
