...
output_directory = "." 
model_name = "spring-petclinic-microservices_233761c"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, circuit_breaker, gateway, infrastructural], tagged_values = {'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Ribbon', 'Gateway': 'Zuul'})
