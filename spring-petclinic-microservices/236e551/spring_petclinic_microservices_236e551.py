...
output_directory = "." 
model_name = "spring-petclinic-microservices_236e551"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul'})
