...
output_directory = "." 
model_name = "spring-petclinic-microservices_2c739b9"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, infrastructural, gateway, circuit_breaker], tagged_values = {'Circuit Breaker': 'Hystrix', 'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud', 'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']"})
