...
output_directory = "." 
model_name = "spring-petclinic-microservices_2c8131c"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, circuit_breaker, gateway, infrastructural], tagged_values = {'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Spring Cloud'})
