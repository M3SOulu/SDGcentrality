...
output_directory = "." 
model_name = "spring-petclinic-microservices_2d992d6"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [circuit_breaker, infrastructural, load_balancer, gateway], tagged_values = {'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul', 'Load Balancer': 'Spring Cloud'})
