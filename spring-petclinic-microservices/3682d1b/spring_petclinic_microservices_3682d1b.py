...
output_directory = "." 
model_name = "spring-petclinic-microservices_3682d1b"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, circuit_breaker, load_balancer, gateway], tagged_values = {'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
