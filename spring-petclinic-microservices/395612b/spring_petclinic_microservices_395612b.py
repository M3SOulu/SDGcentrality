...
output_directory = "." 
model_name = "spring-petclinic-microservices_395612b"
...
petclinic_config_server = CClass(service, "petclinic-config-server", stereotype_instances = [infrastructural, configuration_server], tagged_values = {'Port': 8888, 'Configuration Server': 'Spring Cloud Config'})
