...
output_directory = "." 
model_name = "spring-petclinic-microservices_3d0e4b5"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud'})
