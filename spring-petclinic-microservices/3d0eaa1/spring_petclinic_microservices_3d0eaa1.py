...
output_directory = "." 
model_name = "spring-petclinic-microservices_3d0eaa1"
...
customers_service = CClass(service, "customers-service", stereotype_instances = [internal, local_logging], tagged_values = {'Endpoints': "['/owners/{ownerId}', '/owners']", 'Logging Technology': 'Lombok', 'Port': 8081})
