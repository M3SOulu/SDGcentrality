...
output_directory = "." 
model_name = "spring-petclinic-microservices_497e1d3"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, circuit_breaker, load_balancer], tagged_values = {'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix', 'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']"})
