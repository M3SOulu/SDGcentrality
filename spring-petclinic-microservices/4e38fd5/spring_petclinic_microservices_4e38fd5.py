...
output_directory = "." 
model_name = "spring-petclinic-microservices_4e38fd5"
...
customers_service = CClass(service, "customers-service", stereotype_instances = [internal, local_logging], tagged_values = {'Logging Technology': 'Lombok', 'Endpoints': "['/owners', '/owners/{ownerId}']", 'Port': 8081})
