...
output_directory = "." 
model_name = "spring-petclinic-microservices_52c9ea7"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, load_balancer, gateway, circuit_breaker], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix'})
