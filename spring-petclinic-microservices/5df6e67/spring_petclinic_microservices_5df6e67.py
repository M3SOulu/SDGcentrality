...
output_directory = "." 
model_name = "spring-petclinic-microservices_5df6e67"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon', 'Port': 8081})
customers_service = CClass(service, "customers-service", stereotype_instances = [local_logging, internal], tagged_values = {'Logging Technology': 'Lombok', 'Endpoints': "['/owners/{ownerId}', '/owners']", 'Port': 8081})
