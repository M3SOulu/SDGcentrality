...
output_directory = "." 
model_name = "spring-petclinic-microservices_5f9f614"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [circuit_breaker, infrastructural, load_balancer, gateway], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix'})
