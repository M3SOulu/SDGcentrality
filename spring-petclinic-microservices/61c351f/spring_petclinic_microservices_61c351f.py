...
output_directory = "." 
model_name = "spring-petclinic-microservices_61c351f"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, circuit_breaker, load_balancer], tagged_values = {'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul'})
