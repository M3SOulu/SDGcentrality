...
output_directory = "." 
model_name = "spring-petclinic-microservices_651487f"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [circuit_breaker, gateway, infrastructural, load_balancer], tagged_values = {'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul'})
