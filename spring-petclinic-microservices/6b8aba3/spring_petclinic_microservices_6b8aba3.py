...
output_directory = "." 
model_name = "spring-petclinic-microservices_6b8aba3"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, load_balancer, gateway], tagged_values = {'Port': 8081, 'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul'})
customers_service = CClass(service, "customers-service", stereotype_instances = [local_logging, internal], tagged_values = {'Port': 8081, 'Logging Technology': 'Lombok', 'Endpoints': "['/owners', '/owners/{ownerId}']"})
