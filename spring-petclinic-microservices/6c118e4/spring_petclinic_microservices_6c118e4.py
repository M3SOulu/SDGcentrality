...
output_directory = "." 
model_name = "spring-petclinic-microservices_6c118e4"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Gateway': 'Zuul', 'Port': 8081, 'Load Balancer': 'Ribbon'})
