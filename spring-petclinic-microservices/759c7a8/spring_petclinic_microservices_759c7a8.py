...
output_directory = "." 
model_name = "spring-petclinic-microservices_759c7a8"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [circuit_breaker, load_balancer, gateway, infrastructural], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix'})
