...
output_directory = "." 
model_name = "spring-petclinic-microservices_85f8f36"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway', 'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']"})
