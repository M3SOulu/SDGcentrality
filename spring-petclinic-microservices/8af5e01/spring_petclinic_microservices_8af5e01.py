...
output_directory = "." 
model_name = "spring-petclinic-microservices_8af5e01"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Gateway': 'Spring Cloud Gateway', 'Load Balancer': 'Spring Cloud'})
