...
output_directory = "." 
model_name = "spring-petclinic-microservices_91b6551"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, circuit_breaker, gateway, infrastructural], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix'})
