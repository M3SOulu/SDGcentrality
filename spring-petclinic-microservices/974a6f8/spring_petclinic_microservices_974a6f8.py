...
output_directory = "." 
model_name = "spring-petclinic-microservices_974a6f8"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, circuit_breaker, load_balancer, gateway], tagged_values = {'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix', 'Load Balancer': 'Spring Cloud'})
