...
output_directory = "." 
model_name = "spring-petclinic-microservices_99e6e54"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway', 'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']"})
