...
output_directory = "." 
model_name = "spring-petclinic-microservices_9fce20c"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, load_balancer], tagged_values = {'Port': 8081, 'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul'})
