...
output_directory = "." 
model_name = "spring-petclinic-microservices_a6159bf"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer], tagged_values = {'Gateway': 'Spring Cloud Gateway', 'Endpoints': "['/api/gatewayowners/{ownerId}', '/api/gateway']", 'Load Balancer': 'Spring Cloud'})
