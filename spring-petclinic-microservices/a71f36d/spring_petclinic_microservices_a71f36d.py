...
output_directory = "." 
model_name = "spring-petclinic-microservices_a71f36d"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, gateway, load_balancer, circuit_breaker], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix'})
