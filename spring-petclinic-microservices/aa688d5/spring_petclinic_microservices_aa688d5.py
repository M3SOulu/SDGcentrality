...
output_directory = "." 
model_name = "spring-petclinic-microservices_aa688d5"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, infrastructural, gateway, circuit_breaker], tagged_values = {'Load Balancer': 'Spring Cloud', 'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix'})
