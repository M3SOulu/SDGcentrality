...
output_directory = "." 
model_name = "spring-petclinic-microservices_b173df5"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Load Balancer': 'Spring Cloud', 'Port': 8081, 'Gateway': 'Zuul'})
