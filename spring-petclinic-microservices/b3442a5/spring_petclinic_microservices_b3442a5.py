...
output_directory = "." 
model_name = "spring-petclinic-microservices_b3442a5"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [circuit_breaker, gateway, load_balancer, infrastructural], tagged_values = {'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul', 'Load Balancer': 'Spring Cloud'})
