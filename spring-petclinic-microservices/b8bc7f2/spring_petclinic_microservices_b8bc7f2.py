...
output_directory = "." 
model_name = "spring-petclinic-microservices_b8bc7f2"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, infrastructural, gateway], tagged_values = {'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway'})
