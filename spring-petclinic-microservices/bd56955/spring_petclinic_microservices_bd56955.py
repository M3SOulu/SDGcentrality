...
output_directory = "." 
model_name = "spring-petclinic-microservices_bd56955"
...
petclinic_config_server = CClass(service, "petclinic-config-server", stereotype_instances = [infrastructural, configuration_server], tagged_values = {'Configuration Server': 'Spring Cloud Config', 'Port': 8888})
