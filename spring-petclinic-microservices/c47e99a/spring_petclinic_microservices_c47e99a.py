...
output_directory = "." 
model_name = "spring-petclinic-microservices_c47e99a"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Endpoints': "['/api/gateway', '/api/gatewayowners/{ownerId}']", 'Load Balancer': 'Spring Cloud', 'Gateway': 'Spring Cloud Gateway'})
