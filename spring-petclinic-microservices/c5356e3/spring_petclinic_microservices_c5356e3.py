...
output_directory = "." 
model_name = "spring-petclinic-microservices_c5356e3"
...
customers_service = CClass(service, "customers-service", stereotype_instances = [internal], tagged_values = {'Endpoints': "['/owners', '/owners/{ownerId}']", 'Port': 8081})
