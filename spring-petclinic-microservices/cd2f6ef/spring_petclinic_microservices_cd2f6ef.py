...
output_directory = "." 
model_name = "spring-petclinic-microservices_cd2f6ef"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, infrastructural, load_balancer, circuit_breaker], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix'})
