...
output_directory = "." 
model_name = "spring-petclinic-microservices_d48d31e"
...
customers_service = CClass(service, "customers-service", stereotype_instances = [internal, local_logging], tagged_values = {'Port': 8081, 'Endpoints': "['/owners/{ownerId}', '/owners']", 'Logging Technology': 'Lombok'})
