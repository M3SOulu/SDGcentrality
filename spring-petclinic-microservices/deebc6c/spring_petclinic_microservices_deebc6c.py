...
output_directory = "." 
model_name = "spring-petclinic-microservices_deebc6c"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural], tagged_values = {'Load Balancer': 'Ribbon', 'Port': 8081, 'Gateway': 'Zuul'})
customers_service = CClass(service, "customers-service", stereotype_instances = [internal, local_logging], tagged_values = {'Port': 8081, 'Endpoints': "['/owners', '/owners/{ownerId}']", 'Logging Technology': 'Lombok'})
