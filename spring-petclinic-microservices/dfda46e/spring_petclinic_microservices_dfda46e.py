...
output_directory = "." 
model_name = "spring-petclinic-microservices_dfda46e"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [gateway, load_balancer, infrastructural, circuit_breaker], tagged_values = {'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul'})
