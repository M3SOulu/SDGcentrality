...
output_directory = "." 
model_name = "spring-petclinic-microservices_e527af3"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [infrastructural, circuit_breaker, gateway, load_balancer], tagged_values = {'Load Balancer': 'Ribbon', 'Gateway': 'Zuul', 'Circuit Breaker': 'Hystrix'})
