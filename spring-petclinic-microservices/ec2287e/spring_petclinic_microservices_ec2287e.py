...
output_directory = "." 
model_name = "spring-petclinic-microservices_ec2287e"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, infrastructural], tagged_values = {'Gateway': 'Zuul', 'Load Balancer': 'Ribbon'})
