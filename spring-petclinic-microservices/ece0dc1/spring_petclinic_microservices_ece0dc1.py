...
output_directory = "." 
model_name = "spring-petclinic-microservices_ece0dc1"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [circuit_breaker, infrastructural, gateway, load_balancer], tagged_values = {'Load Balancer': 'Spring Cloud', 'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul'})
