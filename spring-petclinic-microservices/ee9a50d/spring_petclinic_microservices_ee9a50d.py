...
output_directory = "." 
model_name = "spring-petclinic-microservices_ee9a50d"
...
api_gateway = CClass(service, "api-gateway", stereotype_instances = [load_balancer, gateway, circuit_breaker, infrastructural], tagged_values = {'Load Balancer': 'Ribbon', 'Circuit Breaker': 'Hystrix', 'Gateway': 'Zuul'})
